...
var o40176 = temp__5718__auto__;
var temp__5718__auto____$1 = (o40176["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o40177 = temp__5718__auto____$1;
return (o40177["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__39993__auto__ = f;
return (o__39993__auto__["toString"]).call(o__39993__auto__);
} else {
return "";
}
...
try{var o__39993__auto___40180 = t;
(o__39993__auto___40180["cljs$lang$ctorPrWriter"]).call(o__39993__auto___40180,t,writer);
}catch (e40179){var __40181 = e40179;
}
...
var char_code = (function (){var o__39993__auto__ = (new String(char$));
return (o__39993__auto__["charCodeAt"]).call(o__39993__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__39993__auto__ = String;
return (o__39993__auto__["fromCharCode"]).call(o__39993__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__40182 = num_code;
switch (G__40182) {
case (1):
return (185);
...
var o__39993__auto__ = String;
return (o__39993__auto__["fromCharCode"]).call(o__39993__auto__,superscript_code);
});
/**
...
}catch (e40184){var _e__40000__auto__ = e40184;
return false;
}})())){
...
var vec__40185 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__40185,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o40188 = temp__5718__auto__;
var temp__5718__auto____$1 = (o40188["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o40189 = temp__5718__auto____$1;
return (o40189["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___40196 = arguments.length;
var i__4731__auto___40197 = (0);
while(true){
if((i__4731__auto___40197 < len__4730__auto___40196)){
args__4736__auto__.push((arguments[i__4731__auto___40197]));

var G__40198 = (i__4731__auto___40197 + (1));
i__4731__auto___40197 = G__40198;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__40192){
var vec__40193 = p__40192;
var ns_detector = cljs.core.nth.call(null,vec__40193,(0),null);
...
var G__40199 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__40200 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__40199;
remaining_tokens = G__40200;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq40190){
...
var vec__40204 = cljs.core.split_with.call(null,(function (p1__40203_SHARP_){
return cljs.core.not_EQ_.call(null,p1__40203_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__40204,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__40204,(1),null);
...
var vec__40210 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__40210,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__40210,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__40213 = cljs.core.rest.call(null,remaining_tokens);
var G__40214 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__40213;
name_tokens = G__40214;
continue;
} else {
...
var vec__40217 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__40217,(0),null);
var arity = cljs.core.nth.call(null,vec__40217,(1),null);
var vec__40220 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__40220,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__40220,(1),null);
var vec__40223 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__40223,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__40223,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__40223,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__40223,(3),null);
...
var vec__40229 = result;
var munged_ns = cljs.core.nth.call(null,vec__40229,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__40229,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__40229,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__40229,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__40229,(4),null);
var arity = cljs.core.nth.call(null,vec__40229,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__40233 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__40233,(0),null);
var args = cljs.core.nth.call(null,vec__40233,(1),null);
var vec__40236 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__40236,(0),null);
var name = cljs.core.nth.call(null,vec__40236,(1),null);
...
var G__40239 = (arity + (1));
var G__40240 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__40241){
var vec__40242 = p__40241;
var arity = cljs.core.nth.call(null,vec__40242,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__40242,(1),null);
...
return cljs.core.get.call(null,arities,p1__40245_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__40246_SHARP_);
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__40249){
var vec__40250 = p__40249;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__40250,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq40247){
var G__40248 = cljs.core.first.call(null,seq40247);
var seq40247__$1 = cljs.core.next.call(null,seq40247);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__40248,seq40247__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__40258__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__40258__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__40258__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__40258__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__40259 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__40259,(0),null);
var fn_name = cljs.core.nth.call(null,vec__40259,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__40259,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__40259,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__40259,(4),null);
var arity = cljs.core.nth.call(null,vec__40259,(5),null);
...
var o__39993__auto__ = f;
return (o__39993__auto__["getBasis"]).call(o__39993__auto__);
});
/**
...
}catch (e40263){var _e__40000__auto__ = e40263;
...
var G__40264 = (obj[cljs.core.first.call(null,path)]);
var G__40265 = cljs.core.rest.call(null,path);
obj = G__40264;
path = G__40265;
continue;
} else {
...
return (function (accum,p__40266){
var vec__40267 = p__40266;
var bit = cljs.core.nth.call(null,vec__40267,(0),null);
var protocol = cljs.core.nth.call(null,vec__40267,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__40270){
var vec__40271 = p__40270;
var ns = cljs.core.nth.call(null,vec__40271,(0),null);
var name = cljs.core.nth.call(null,vec__40271,(1),null);
var selector = cljs.core.nth.call(null,vec__40271,(2),null);
...
return (function (p__40275){
var vec__40276 = p__40275;
var munged_name = cljs.core.nth.call(null,vec__40276,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__40276,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__40276,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__40274_SHARP_){
return (obj[cljs.core.first.call(null,p1__40274_SHARP_)]);
});})(name,sorted_matches,vec__40276,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
