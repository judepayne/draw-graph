...
var G__40752 = devtools.prefs.pref.call(null,v);
v = G__40752;
continue;
} else {
return v;
...
}catch (e40755){var _e__40000__auto__ = e40755;
return false;
}})();
...
}catch (e40759){var _e__40000__auto__ = e40759;
return false;
}})();
...
}catch (e40761){var _e__40000__auto__ = e40761;
return false;
}}
}
});
...
var vec__40763 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__40763,(0),null);
var name = cljs.core.nth.call(null,vec__40763,(1),null);
...
return cljs.core.some.call(null,(function (p1__40766_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__40766_SHARP_);
}),template);
});
