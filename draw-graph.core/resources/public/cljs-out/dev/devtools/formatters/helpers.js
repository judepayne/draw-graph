...
var G__11998 = devtools.prefs.pref.call(null,v);
v = G__11998;
continue;
} else {
return v;
...
}catch (e12001){var _e__11012__auto__ = e12001;
return false;
}})();
...
}catch (e12005){var _e__11012__auto__ = e12005;
return false;
}})();
...
}catch (e12007){var _e__11012__auto__ = e12007;
return false;
}}
}
});
...
var vec__12009 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__12009,(0),null);
var name = cljs.core.nth.call(null,vec__12009,(1),null);
...
return cljs.core.some.call(null,(function (p1__12012_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12012_SHARP_);
}),template);
});
