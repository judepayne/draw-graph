...
var line = cljs.core.get.call(null,map__44532__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__44532__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error.call(null,error.message,file,line,column);
}catch (e44531){var _e = e44531;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5718__auto___44534 = devtools.hints.get_processed_errors_BANG_.call(null);
if(cljs.core.truth_(temp__5718__auto___44534)){
var seen_errors_44535 = temp__5718__auto___44534;
if(cljs.core.truth_(seen_errors_44535.has(self))){
} else {
seen_errors_44535.add(self);

var temp__5720__auto___44536 = devtools.hints.error_object_sense.call(null,self);
if(cljs.core.truth_(temp__5720__auto___44536)){
var sense_44537 = temp__5720__auto___44536;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_44537)].join('');
} else {
}
}
} else {
