...
if((i < len)){
var k = (ks[i]);
var G__11014 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__11015 = (i + (1));
m = G__11014;
i = G__11015;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__11016 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__11016) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__11016));
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11018 = c;
var G__11018__$1 = (((G__11018 == null))?null:G__11018.prototype);
if((G__11018__$1 == null)){
return null;
} else {
return (G__11018__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__11020 = c;
var G__11020__$1 = (((G__11020 == null))?null:G__11020.prototype);
if((G__11020__$1 == null)){
return null;
} else {
return (G__11020__$1["render"]);
}
})() == null)))));
});
...
var G__11022 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__11022) : reagent.impl.component.as_element.call(null,G__11022));
};
...
while (G__11025__i < G__11025__a.length) {G__11025__a[G__11025__i] = arguments[G__11025__i + 0]; ++G__11025__i;}
  args = new cljs.core.IndexedSeq(G__11025__a,0,null);
} 
...
var _STAR_current_component_STAR__orig_val__11028 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__11029 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__11029;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__11028;
}});
...
return ((function (G__11030,G__11030__$1){
...
var c = this;
var G__11035_11037 = (c["cljsRatom"]);
if((G__11035_11037 == null)){
} else {
reagent.ratom.dispose_BANG_(G__11035_11037);
}
...
var renders_11039 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_11040 = cljs.core.first(cljs.core.vals(renders_11039));
if((cljs.core.count(renders_11039) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_11039))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_11040)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_11040], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__11038 = name;
switch (G__11038) {
case "":
...
var G__11043 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__11043) : reagent.impl.component.global$module$create_react_class.call(null,G__11043));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__11044 = fiber;
var G__11044__$1 = (((G__11044 == null))?null:(G__11044["type"]));
if((G__11044__$1 == null)){
return null;
} else {
return (G__11044__$1["displayName"]);
}
})();
var parent = (function (){var G__11045 = fiber;
if((G__11045 == null)){
return null;
} else {
return (G__11045["return"]);
}
})();
var path = (function (){var G__11046 = parent;
var G__11046__$1 = (((G__11046 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__11046) : reagent.impl.component.fiber_component_path.call(null,G__11046)));
if((G__11046__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11046__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__11048 = c;
if((G__11048 == null)){
return null;
} else {
return (G__11048["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__11049._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__11051 = c;
if((G__11051 == null)){
return null;
} else {
return (G__11051["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__11053 = c;
if((G__11053 == null)){
return null;
} else {
return G__11053._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__11055 = instance;
if((G__11055 == null)){
return null;
} else {
return (G__11055["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__11056 = instance;
if((G__11056 == null)){
return null;
} else {
return G__11056._currentElement;
}
}
})();
var name = (function (){var G__11057 = elem;
var G__11057__$1 = (((G__11057 == null))?null:(G__11057["type"]));
if((G__11057__$1 == null)){
return null;
} else {
return (G__11057__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__11059 = elem;
if((G__11059 == null)){
return null;
} else {
return (G__11059["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__11060._owner;
}
}
})();
var path = (function (){var G__11061 = owner;
var G__11061__$1 = (((G__11061 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__11061) : reagent.impl.component.component_path.call(null,G__11061)));
if((G__11061__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__11061__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__11062 = c;
var G__11062__$1 = (((G__11062 == null))?null:G__11062.constructor);
if((G__11062__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__11062__$1);
}
}
})();
