...
var len__4730__auto___10267 = arguments.length;
var i__4731__auto___10268 = (0);
while(true){
if((i__4731__auto___10268 < len__4730__auto___10267)){
args__4736__auto__.push((arguments[i__4731__auto___10268]));

var G__10269 = (i__4731__auto___10268 + (1));
i__4731__auto___10268 = G__10269;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs_test_display.core.n.cljs$lang$applyTo = (function (seq10264){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__10265,G__10266,seq10264__$2);
});
...
var vec__10270 = ((clojure.string.starts_with_QMARK_.call(null,cljs.core.first.call(null,classes),"#"))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,cljs.core.first.call(null,classes),(1)),cljs.core.rest.call(null,classes)], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,classes], null));
var id = cljs.core.nth.call(null,vec__10270,(0),null);
var classes__$1 = cljs.core.nth.call(null,vec__10270,(1),null);
var G__10273 = cljs.core.PersistentArrayMap.EMPTY;
var G__10273__$1 = (cljs.core.truth_(id)?cljs.core.assoc.call(null,G__10273,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__10273);
if(cljs.core.truth_(cljs.core.not_empty.call(null,classes__$1))){
return cljs.core.assoc.call(null,G__10273__$1,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",classes__$1));
} else {
return G__10273__$1;
}
} else {
...
return (function() { 
var G__10277__delegate = function (klass,contents){
var vec__10274 = (((klass instanceof cljs.core.Keyword))?new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [klass,contents], null):new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [null,cljs.core.cons.call(null,klass,contents)], null));
var klass__$1 = cljs.core.nth.call(null,vec__10274,(0),null);
var contents__$1 = cljs.core.nth.call(null,vec__10274,(1),null);
...
var G__10277 = function (klass,var_args){
var contents = null;
...
while (G__10278__i < G__10278__a.length) {G__10278__a[G__10278__i] = arguments[G__10278__i + 1]; ++G__10278__i;}
  contents = new cljs.core.IndexedSeq(G__10278__a,0,null);
} 
return G__10277__delegate.call(this,klass,contents);};
G__10277.cljs$lang$maxFixedArity = 1;
G__10277.cljs$lang$applyTo = (function (arglist__10279){
var klass = cljs.core.first(arglist__10279);
var contents = cljs.core.rest(arglist__10279);
return G__10277__delegate(klass,contents);
});
...
cljs_test_display.core.process_file_name = (function cljs_test_display$core$process_file_name(p__10283){
var map__10284 = p__10283;
var map__10284__$1 = (((((!((map__10284 == null))))?(((((map__10284.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__10284.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__10284):map__10284);
var ns = cljs.core.get.call(null,map__10284__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
...
cljs_test_display.core.comparison = (function cljs_test_display$core$comparison(p__10286){
...
var actual = cljs.core.get.call(null,map__10287__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
var expected = cljs.core.get.call(null,map__10287__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
...
cljs_test_display.core.error_comparison = (function cljs_test_display$core$error_comparison(p__10289){
...
var expected = cljs.core.get.call(null,map__10290__$1,new cljs.core.Keyword(null,"expected","expected",1583670997));
var actual = cljs.core.get.call(null,map__10290__$1,new cljs.core.Keyword(null,"actual","actual",107306363));
...
return cljs.core.cons.call(null,new_current_node,p1__10292_SHARP_);
...
var curr_node = cljs_test_display.core.current_node.call(null);
var map__10294 = cljs_test_display.core.current_var_info.call(null);
...
cljs.core.swap_BANG_.call(null,cljs_test_display.core.state,cljs.core.update,new cljs.core.Keyword(null,"current-node","current-node",-814308842),((function (curr_node,map__10294,map__10294__$1,info,name,line,file,node){
return (function (p1__10293_SHARP_){
return cljs.core.cons.call(null,node,p1__10293_SHARP_);
});})(curr_node,map__10294,map__10294__$1,info,name,line,file,node))
);

return goog.dom.appendChild(curr_node,node);
});
cljs_test_display.core.summary = (function cljs_test_display$core$summary(p__10296){
...
var m = map__10297__$1;
var fail = cljs.core.get.call(null,map__10297__$1,new cljs.core.Keyword(null,"fail","fail",1706214930));
var error = cljs.core.get.call(null,map__10297__$1,new cljs.core.Keyword(null,"error","error",-978969032));
var pass = cljs.core.get.call(null,map__10297__$1,new cljs.core.Keyword(null,"pass","pass",1574159993));
var test = cljs.core.get.call(null,map__10297__$1,new cljs.core.Keyword(null,"test","test",577538877));
...
var temp__5720__auto___10299 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10299)){
var message_10300 = temp__5720__auto___10299;
cljs.core.println.call(null,message_10300);
} else {
}
...
var temp__5720__auto___10301 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___10301)){
var message_10302 = temp__5720__auto___10301;
cljs.core.println.call(null,message_10302);
} else {
}
