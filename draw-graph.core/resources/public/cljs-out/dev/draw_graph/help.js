...
draw_graph.help.boundary = cljs.core.zipmap.call(null,new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"x","x",2099068185),new cljs.core.Keyword(null,"y","y",-1757859776),new cljs.core.Keyword(null,"w","w",354169001),new cljs.core.Keyword(null,"h","h",1109658740)], null),draw_graph.help.bounds);
draw_graph.help.sep = (5);
draw_graph.help.inner_boundary = lib_draw_graph.geometry.inner_rect.call(null,draw_graph.help.sep,draw_graph.help.boundary);
draw_graph.help.rand_rect = (function draw_graph$help$rand_rect(bdry){
return cljs.core.PersistentArrayMap.createAsIfByAssoc([cljs.core.gensym.call(null),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"x","x",2099068185),(new cljs.core.Keyword(null,"x","x",2099068185).cljs$core$IFn$_invoke$arity$1(bdry) + cljs.core.rand_int.call(null,new cljs.core.Keyword(null,"w","w",354169001).cljs$core$IFn$_invoke$arity$1(bdry))),new cljs.core.Keyword(null,"y","y",-1757859776),(new cljs.core.Keyword(null,"y","y",-1757859776).cljs$core$IFn$_invoke$arity$1(bdry) + cljs.core.rand_int.call(null,new cljs.core.Keyword(null,"h","h",1109658740).cljs$core$IFn$_invoke$arity$1(bdry))),new cljs.core.Keyword(null,"w","w",354169001),cljs.core.rand_int.call(null,((new cljs.core.Keyword(null,"w","w",354169001).cljs$core$IFn$_invoke$arity$1(bdry) / (5)) | (0))),new cljs.core.Keyword(null,"h","h",1109658740),cljs.core.rand_int.call(null,((new cljs.core.Keyword(null,"h","h",1109658740).cljs$core$IFn$_invoke$arity$1(bdry) / (5)) | (0)))], null)]);
});
draw_graph.help.rand_rects_STAR_ = (function draw_graph$help$rand_rects_STAR_(bdry,sep){
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons.call(null,draw_graph.help.rand_rect.call(null,bdry),draw_graph.help.rand_rects_STAR_.call(null,bdry));
}),null,null));
});
draw_graph.help.rand_rects = (function draw_graph$help$rand_rects(n,bdry,sep){
return cljs.core.reduce.call(null,(function (a,c){
if(cljs.core._EQ_.call(null,cljs.core.count.call(null,a),n)){
return cljs.core.reduced.call(null,a);
} else {
if(((cljs.core.not_any_QMARK_.call(null,(function (p1__39636_SHARP_){
return cljs.core.partial.call(null,lib_draw_graph.geometry.overlaps_QMARK_,sep,cljs.core.first.call(null,cljs.core.vals.call(null,c))).call(null,p1__39636_SHARP_);
}),cljs.core.vals.call(null,a))) && (lib_draw_graph.geometry.inside_QMARK_.call(null,bdry,cljs.core.first.call(null,cljs.core.vals.call(null,c)))))){
return cljs.core.merge.call(null,a,c);
} else {
return a;
}
}
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.take.call(null,(n + (30)),draw_graph.help.rand_rects_STAR_.call(null,bdry,sep)));
});
...
draw_graph.help.state = reagent.core.atom.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"running","running",1554969103),false], null));
...
draw_graph.help.rect.cljs$core$IFn$_invoke$arity$variadic = (function (r,p__39639){
...
var fill_QMARK_ = cljs.core.get.call(null,map__39640__$1,new cljs.core.Keyword(null,"fill?","fill?",-485702148),false);
...
/** @this {Function} */
draw_graph.help.rect.cljs$lang$applyTo = (function (seq39637){
...
return draw_graph.help.rand_rects.call(null,((4) + cljs.core.rand_int.call(null,(7))),draw_graph.help.inner_boundary,(5));
});
...
return cljs.core.map.call(null,(function (p1__39645_SHARP_){
return draw_graph.help.rect.call(null,p1__39645_SHARP_,new cljs.core.Keyword(null,"fill?","fill?",-485702148),filled_QMARK_);
}),cljs.core.vals.call(null,state));
} else {
return cljs.core.map.call(null,(function (p1__39646_SHARP_){
return draw_graph.help.rect.call(null,p1__39646_SHARP_);
}),cljs.core.vals.call(null,state));
}
});
...
if(cljs.core.truth_(new cljs.core.Keyword(null,"running","running",1554969103).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,draw_graph.help.state)))){
return cljs.core.swap_BANG_.call(null,draw_graph.help.state,cljs.core.assoc,new cljs.core.Keyword(null,"state","state",-1988618099),lib_draw_graph.anneal.annealing.call(null,new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,draw_graph.help.state)),n,(0),new cljs.core.Keyword(null,"constraints","constraints",422775616).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,draw_graph.help.state)),lib_draw_graph.anneal.neighbor_fn,lib_draw_graph.anneal.cost_fn,lib_draw_graph.anneal.p_fn,lib_draw_graph.anneal.temp_fn,new cljs.core.Keyword(null,"dims","dims",-466522889),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"x","x",2099068185),new cljs.core.Keyword(null,"y","y",-1757859776),new cljs.core.Keyword(null,"w","w",354169001),new cljs.core.Keyword(null,"h","h",1109658740)], null)));
} else {
return null;
}
});
...
return (function (state_39663){
var state_val_39664 = (state_39663[(1)]);
if((state_val_39664 === (1))){
var inst_39647 = (0);
var state_39663__$1 = (function (){var statearr_39665 = state_39663;
(statearr_39665[(7)] = inst_39647);

return statearr_39665;
})();
var statearr_39666_39678 = state_39663__$1;
(statearr_39666_39678[(2)] = null);

(statearr_39666_39678[(1)] = (2));


return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_39664 === (2))){
var inst_39647 = (state_39663[(7)]);
var inst_39649 = (inst_39647 < (72));
var state_39663__$1 = state_39663;
if(cljs.core.truth_(inst_39649)){
var statearr_39667_39679 = state_39663__$1;
(statearr_39667_39679[(1)] = (4));

} else {
var statearr_39668_39680 = state_39663__$1;
(statearr_39668_39680[(1)] = (5));

}

return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_39664 === (3))){
var inst_39661 = (state_39663[(2)]);
var state_39663__$1 = state_39663;
return cljs.core.async.impl.ioc_helpers.return_chan.call(null,state_39663__$1,inst_39661);
} else {
if((state_val_39664 === (4))){
var inst_39651 = draw_graph.help.a.call(null,(100));
var inst_39652 = draw_graph.help.timeout.call(null,(40));
var state_39663__$1 = (function (){var statearr_39669 = state_39663;
(statearr_39669[(8)] = inst_39651);

return statearr_39669;
})();
return cljs.core.async.impl.ioc_helpers.take_BANG_.call(null,state_39663__$1,(7),inst_39652);
} else {
if((state_val_39664 === (5))){
var state_39663__$1 = state_39663;
var statearr_39670_39681 = state_39663__$1;
(statearr_39670_39681[(2)] = null);

(statearr_39670_39681[(1)] = (6));


return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_39664 === (6))){
var inst_39659 = (state_39663[(2)]);
var state_39663__$1 = state_39663;
var statearr_39671_39682 = state_39663__$1;
(statearr_39671_39682[(2)] = inst_39659);

(statearr_39671_39682[(1)] = (3));


return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_39664 === (7))){
var inst_39647 = (state_39663[(7)]);
var inst_39654 = (state_39663[(2)]);
var inst_39655 = (inst_39647 + (1));
var inst_39647__$1 = inst_39655;
var state_39663__$1 = (function (){var statearr_39672 = state_39663;
(statearr_39672[(9)] = inst_39654);

(statearr_39672[(7)] = inst_39647__$1);

return statearr_39672;
})();
var statearr_39673_39683 = state_39663__$1;
(statearr_39673_39683[(2)] = null);

(statearr_39673_39683[(1)] = (2));
...
return (function() {
var draw_graph$help$anneal_$_state_machine__22015__auto__ = null;
var draw_graph$help$anneal_$_state_machine__22015__auto____0 = (function (){
var statearr_39674 = [null,null,null,null,null,null,null,null,null,null];
(statearr_39674[(0)] = draw_graph$help$anneal_$_state_machine__22015__auto__);

(statearr_39674[(1)] = (1));

return statearr_39674;
});
var draw_graph$help$anneal_$_state_machine__22015__auto____1 = (function (state_39663){
while(true){
var ret_value__22016__auto__ = (function (){try{while(true){
var result__22017__auto__ = switch__22014__auto__.call(null,state_39663);
...
var ex__22018__auto__ = e39675;
var statearr_39676_39684 = state_39663;
(statearr_39676_39684[(5)] = ex__22018__auto__);


cljs.core.async.impl.ioc_helpers.process_exception.call(null,state_39663);
...
var G__39685 = state_39663;
state_39663 = G__39685;
continue;
} else {
...
draw_graph$help$anneal_$_state_machine__22015__auto__ = function(state_39663){
switch(arguments.length){
case 0:
return draw_graph$help$anneal_$_state_machine__22015__auto____0.call(this);
case 1:
return draw_graph$help$anneal_$_state_machine__22015__auto____1.call(this,state_39663);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
draw_graph$help$anneal_$_state_machine__22015__auto__.cljs$core$IFn$_invoke$arity$0 = draw_graph$help$anneal_$_state_machine__22015__auto____0;
draw_graph$help$anneal_$_state_machine__22015__auto__.cljs$core$IFn$_invoke$arity$1 = draw_graph$help$anneal_$_state_machine__22015__auto____1;
return draw_graph$help$anneal_$_state_machine__22015__auto__;
})()
;})(switch__22014__auto__,c__22181__auto__))
})();
var state__22183__auto__ = (function (){var statearr_39677 = f__22182__auto__.call(null);
(statearr_39677[(6)] = c__22181__auto__);
...
var rects = draw_graph.help.gen_rects.call(null);
var ob_QMARK_ = ((cljs.core._EQ_.call(null,(0),cljs.core.rand_int.call(null,(2))))?false:true);
var st = ((ob_QMARK_)?cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.rest.call(null,rects)):rects);
var obs = ((ob_QMARK_)?cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first.call(null,rects)], null)):cljs.core.PersistentVector.EMPTY);
cljs.core.swap_BANG_.call(null,draw_graph.help.state,cljs.core.assoc,new cljs.core.Keyword(null,"state","state",-1988618099),st);

cljs.core.swap_BANG_.call(null,draw_graph.help.state,cljs.core.assoc,new cljs.core.Keyword(null,"running","running",1554969103),false);

return cljs.core.swap_BANG_.call(null,draw_graph.help.state,cljs.core.assoc,new cljs.core.Keyword(null,"constraints","constraints",422775616),cljs.core.assoc.call(null,draw_graph.help.constraints,new cljs.core.Keyword(null,"obstacles","obstacles",1370670211),obs));
});
draw_graph.help.anneal_demo = (function draw_graph$help$anneal_demo(){
return (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.anneal-demo","div.anneal-demo",-437253449),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"svg","svg",856789142),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"x","x",2099068185),(0),new cljs.core.Keyword(null,"y","y",-1757859776),(0),new cljs.core.Keyword(null,"width","width",-384071477),(600),new cljs.core.Keyword(null,"height","height",1025178622),(400)], null),draw_graph.help.rect.call(null,draw_graph.help.boundary),draw_graph.help.rects__GT_svg.call(null,new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,draw_graph.help.state)),false),draw_graph.help.rects__GT_svg.call(null,new cljs.core.Keyword(null,"obstacles","obstacles",1370670211).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"constraints","constraints",422775616).cljs$core$IFn$_invoke$arity$1(cljs.core.deref.call(null,draw_graph.help.state))),true)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"button",new cljs.core.Keyword(null,"value","value",305978217),"Generate",new cljs.core.Keyword(null,"on-click","on-click",1632826543),draw_graph.help.generate], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"button",new cljs.core.Keyword(null,"value","value",305978217),"Anneal!",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
cljs.core.swap_BANG_.call(null,draw_graph.help.state,cljs.core.assoc,new cljs.core.Keyword(null,"running","running",1554969103),true);

return draw_graph.help.anneal.call(null);
})], null)], null)], null);
});
});
draw_graph.help.help_page = (function draw_graph$help$help_page(){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.block-text","div.block-text",1029445422),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),draw_graph.utils.md__GT_hiccup.call(null,draw_graph.help.section_1)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),"(slowed down ~50x. Obstacles shown as filled rectangles.)"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [draw_graph.help.anneal_demo], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),draw_graph.utils.md__GT_hiccup.call(null,draw_graph.help.section_2)], null)], null);
});
