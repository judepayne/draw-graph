...
var G__9880 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__9880;
continue;
} else {
return ch;
...
var vec__9881 = cljs.core.re_find.call(null,pattern,s);
var match = cljs.core.nth.call(null,vec__9881,(0),null);
return (match === s);
});
...
/** @this {Function} */
cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq9884){
...
return (function() { 
var G__9889__delegate = function (rdr,_){
return cljs.tools.reader.impl.errors.reader_error.call(null,rdr,msg);
};
var G__9889 = function (rdr,var_args){
var _ = null;
...
while (G__9890__i < G__9890__a.length) {G__9890__a[G__9890__i] = arguments[G__9890__i + 1]; ++G__9890__i;}
  _ = new cljs.core.IndexedSeq(G__9890__a,0,null);
} 
return G__9889__delegate.call(this,rdr,_);};
G__9889.cljs$lang$maxFixedArity = 1;
G__9889.cljs$lang$applyTo = (function (arglist__9891){
var rdr = cljs.core.first(arglist__9891);
var _ = cljs.core.rest(arglist__9891);
return G__9889__delegate(rdr,_);
});
