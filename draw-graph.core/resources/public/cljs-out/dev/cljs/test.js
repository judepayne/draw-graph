...
var G__27360 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"report-counters","report-counters",-1702609242),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"test","test",577538877),(0),new cljs.core.Keyword(null,"pass","pass",1574159993),(0),new cljs.core.Keyword(null,"fail","fail",1706214930),(0),new cljs.core.Keyword(null,"error","error",-978969032),(0)], null),new cljs.core.Keyword(null,"testing-vars","testing-vars",-2114769150),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"testing-contexts","testing-contexts",-1485646523),cljs.core.List.EMPTY,new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.core.pr_str,new cljs.core.Keyword(null,"reporter","reporter",-805360621),reporter], null);
if(cljs.core._EQ_.call(null,new cljs.core.Keyword("cljs.test","pprint","cljs.test/pprint",1627393641),reporter)){
return cljs.core.assoc.call(null,G__27360,new cljs.core.Keyword(null,"reporter","reporter",-805360621),new cljs.core.Keyword("cljs.test","default","cljs.test/default",-1581405322),new cljs.core.Keyword(null,"formatter","formatter",-483008823),cljs.pprint.pprint);
} else {
return G__27360;
}
});
...
args__4736__auto__.push((arguments[i__4731__auto___27366]));
...
/** @this {Function} */
cljs.test.update_current_env_BANG_.cljs$lang$applyTo = (function (seq27362){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__27363,G__27364,seq27362__$2);
});
...
var line = cljs.core.get.call(null,map__27369__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.call(null,map__27369__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.reverse.call(null,cljs.core.map.call(null,((function (map__27369,map__27369__$1,file,line,column){
return (function (p1__27368_SHARP_){
return new cljs.core.Keyword(null,"name","name",1843675177).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,p1__27368_SHARP_));
});})(map__27369,map__27369__$1,file,line,column))
...
var temp__5720__auto___27371 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___27371)){
var message_27372 = temp__5720__auto___27371;
cljs.core.println.call(null,message_27372);
} else {
}
...
var temp__5720__auto___27373 = new cljs.core.Keyword(null,"message","message",-406056002).cljs$core$IFn$_invoke$arity$1(m);
if(cljs.core.truth_(temp__5720__auto___27373)){
var message_27374 = temp__5720__auto___27373;
cljs.core.println.call(null,message_27374);
} else {
}
...
var output_dir__$1 = (function (){var G__27375 = output_dir;
if((!(clojure.string.ends_with_QMARK_.call(null,output_dir,"/")))){
return [G__27375,"/"].join('');
} else {
return G__27375;
}
})();
...
var G__27377 = exception.stack;
var G__27377__$1 = (((G__27377 == null))?null:clojure.string.split_lines.call(null,G__27377));
var G__27377__$2 = (((G__27377__$1 == null))?null:cljs.core.get.call(null,G__27377__$1,depth));
if((G__27377__$2 == null)){
return null;
} else {
return clojure.string.trim.call(null,G__27377__$2);
}
} else {
...
var vec__27378 = cljs.test.js_line_and_column.call(null,stack_element);
var line = cljs.core.nth.call(null,vec__27378,(0),null);
var column = cljs.core.nth.call(null,vec__27378,(1),null);
var vec__27381 = cljs.test.mapped_line_and_column.call(null,fname,line,column);
var fname__$1 = cljs.core.nth.call(null,vec__27381,(0),null);
var line__$1 = cljs.core.nth.call(null,vec__27381,(1),null);
var column__$1 = cljs.core.nth.call(null,vec__27381,(2),null);
...
var m__$1 = (function (){var G__27384 = new cljs.core.Keyword(null,"type","type",1174270348).cljs$core$IFn$_invoke$arity$1(m);
...
var G__27388 = (function (){var G__27387 = cljs.core.rest.call(null,fns);
...
return cljs.core.concat.call(null,obj,G__27387);
} else {
return G__27387;
}
})();
...
return cljs.core.vary_meta.call(null,G__27389,cljs.core.assoc,new cljs.core.Keyword("cljs.test","block?","cljs.test/block?",686379965),true);
}
});
...
var vec__27393 = fixtures_types.call(null);
var type = cljs.core.nth.call(null,vec__27393,(0),null);
var types = vec__27393;
...
return cljs.core.map.call(null,(function (p__27396){
var vec__27397 = p__27396;
var ns = cljs.core.nth.call(null,vec__27397,(0),null);
var vars__$1 = cljs.core.nth.call(null,vec__27397,(1),null);
return ((function (vec__27397,ns,vars__$1){
return (function (){
...
var G__27400 = cljs.test.execution_strategy.call(null,once_fixtures,each_fixtures);
...
return new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [((function (each_fixture_fn,G__27400,G__27400__$1,env,once_fixtures,each_fixtures,vec__27397,ns,vars__$1){
return (function (){
return cljs.test.join_fixtures.call(null,once_fixtures).call(null,((function (each_fixture_fn,G__27400,G__27400__$1,env,once_fixtures,each_fixtures,vec__27397,ns,vars__$1){
return (function (){
var seq__27401 = cljs.core.seq.call(null,vars__$1);
var chunk__27402 = null;
var count__27403 = (0);
var i__27404 = (0);
while(true){
if((i__27404 < count__27403)){
var v = cljs.core._nth.call(null,chunk__27402,i__27404);
var temp__5720__auto___27406 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___27406)){
var t_27407 = temp__5720__auto___27406;
each_fixture_fn.call(null,((function (seq__27401,chunk__27402,count__27403,i__27404,t_27407,temp__5720__auto___27406,v,each_fixture_fn,G__27400,G__27400__$1,env,once_fixtures,each_fixtures,vec__27397,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_27407)));
});})(seq__27401,chunk__27402,count__27403,i__27404,t_27407,temp__5720__auto___27406,v,each_fixture_fn,G__27400,G__27400__$1,env,once_fixtures,each_fixtures,vec__27397,ns,vars__$1))
);
} else {
}


var G__27408 = seq__27401;
var G__27409 = chunk__27402;
var G__27410 = count__27403;
var G__27411 = (i__27404 + (1));
seq__27401 = G__27408;
chunk__27402 = G__27409;
count__27403 = G__27410;
i__27404 = G__27411;
continue;
} else {
var temp__5720__auto__ = cljs.core.seq.call(null,seq__27401);
if(temp__5720__auto__){
var seq__27401__$1 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__27401__$1)){
var c__4550__auto__ = cljs.core.chunk_first.call(null,seq__27401__$1);
var G__27412 = cljs.core.chunk_rest.call(null,seq__27401__$1);
var G__27413 = c__4550__auto__;
var G__27414 = cljs.core.count.call(null,c__4550__auto__);
var G__27415 = (0);
seq__27401 = G__27412;
chunk__27402 = G__27413;
count__27403 = G__27414;
i__27404 = G__27415;
continue;
} else {
var v = cljs.core.first.call(null,seq__27401__$1);
var temp__5720__auto___27416__$1 = new cljs.core.Keyword(null,"test","test",577538877).cljs$core$IFn$_invoke$arity$1(cljs.core.meta.call(null,v));
if(cljs.core.truth_(temp__5720__auto___27416__$1)){
var t_27417 = temp__5720__auto___27416__$1;
each_fixture_fn.call(null,((function (seq__27401,chunk__27402,count__27403,i__27404,t_27417,temp__5720__auto___27416__$1,v,seq__27401__$1,temp__5720__auto__,each_fixture_fn,G__27400,G__27400__$1,env,once_fixtures,each_fixtures,vec__27397,ns,vars__$1){
return (function (){
return cljs.test.run_block.call(null,cljs.test.test_var_block_STAR_.call(null,v,cljs.test.disable_async.call(null,t_27417)));
});})(seq__27401,chunk__27402,count__27403,i__27404,t_27417,temp__5720__auto___27416__$1,v,seq__27401__$1,temp__5720__auto__,each_fixture_fn,G__27400,G__27400__$1,env,once_fixtures,each_fixtures,vec__27397,ns,vars__$1))
);
} else {
}


var G__27418 = cljs.core.next.call(null,seq__27401__$1);
var G__27419 = null;
var G__27420 = (0);
var G__27421 = (0);
seq__27401 = G__27418;
chunk__27402 = G__27419;
count__27403 = G__27420;
i__27404 = G__27421;
continue;
}
} else {
...
});})(each_fixture_fn,G__27400,G__27400__$1,env,once_fixtures,each_fixtures,vec__27397,ns,vars__$1))
);
});})(each_fixture_fn,G__27400,G__27400__$1,env,once_fixtures,each_fixtures,vec__27397,ns,vars__$1))
], null);
...
break;
default:
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__27400__$1)].join('')));

}
})());
});
;})(vec__27397,ns,vars__$1))
