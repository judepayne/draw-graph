...
var o9661 = temp__5718__auto__;
var temp__5718__auto____$1 = (o9661["core"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o9662 = temp__5718__auto____$1;
return (o9662["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__8773__auto__ = f;
return (o__8773__auto__["toString"]).call(o__8773__auto__);
} else {
return "";
}
}catch (e9663){var _ = e9663;
return "";
}});
...
try{var o__8773__auto___9665 = t;
(o__8773__auto___9665["cljs$lang$ctorPrWriter"]).call(o__8773__auto___9665,t,writer);
}catch (e9664){var __9666 = e9664;
}
...
var char_code = (function (){var o__8773__auto__ = (new String(char$));
return (o__8773__auto__["charCodeAt"]).call(o__8773__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__8773__auto__ = String;
return (o__8773__auto__["fromCharCode"]).call(o__8773__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__9667 = num_code;
switch (G__9667) {
case (1):
return (185);
...
var o__8773__auto__ = String;
return (o__8773__auto__["fromCharCode"]).call(o__8773__auto__,superscript_code);
});
/**
...
}catch (e9669){var _e__8780__auto__ = e9669;
return false;
}})())){
...
var vec__9670 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__9670,(0),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var o9673 = temp__5718__auto__;
var temp__5718__auto____$1 = (o9673["dependencies_"]);
if(cljs.core.truth_(temp__5718__auto____$1)){
var o9674 = temp__5718__auto____$1;
return (o9674["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4730__auto___9681 = arguments.length;
var i__4731__auto___9682 = (0);
while(true){
if((i__4731__auto___9682 < len__4730__auto___9681)){
args__4736__auto__.push((arguments[i__4731__auto___9682]));

var G__9683 = (i__4731__auto___9682 + (1));
i__4731__auto___9682 = G__9683;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__9677){
var vec__9678 = p__9677;
var ns_detector = cljs.core.nth.call(null,vec__9678,(0),null);
...
var G__9684 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__9685 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__9684;
remaining_tokens = G__9685;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq9675){
var G__9676 = cljs.core.first.call(null,seq9675);
var seq9675__$1 = cljs.core.next.call(null,seq9675);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9676,seq9675__$1);
});
...
var vec__9689 = cljs.core.split_with.call(null,(function (p1__9688_SHARP_){
return cljs.core.not_EQ_.call(null,p1__9688_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__9689,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__9689,(1),null);
...
var vec__9695 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__9695,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__9695,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__9698 = cljs.core.rest.call(null,remaining_tokens);
var G__9699 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__9698;
name_tokens = G__9699;
continue;
} else {
...
var vec__9702 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__9702,(0),null);
var arity = cljs.core.nth.call(null,vec__9702,(1),null);
var vec__9705 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__9705,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__9705,(1),null);
var vec__9708 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__9708,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__9708,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__9708,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__9708,(3),null);
...
var vec__9714 = result;
var munged_ns = cljs.core.nth.call(null,vec__9714,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__9714,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__9714,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__9714,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__9714,(4),null);
var arity = cljs.core.nth.call(null,vec__9714,(5),null);
...
if(cljs.core.truth_(temp__5718__auto__)){
var vec__9718 = temp__5718__auto__;
var munged_name = cljs.core.nth.call(null,vec__9718,(0),null);
var args = cljs.core.nth.call(null,vec__9718,(1),null);
var vec__9721 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__9721,(0),null);
var name = cljs.core.nth.call(null,vec__9721,(1),null);
...
var G__9724 = (arity + (1));
var G__9725 = (function (){var temp__5718__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5718__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__9726){
var vec__9727 = p__9726;
var arity = cljs.core.nth.call(null,vec__9727,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__9727,(1),null);
...
return cljs.core.get.call(null,arities,p1__9730_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__9731_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___9738 = arguments.length;
var i__4731__auto___9739 = (0);
while(true){
if((i__4731__auto___9739 < len__4730__auto___9738)){
args__4736__auto__.push((arguments[i__4731__auto___9739]));

var G__9740 = (i__4731__auto___9739 + (1));
i__4731__auto___9739 = G__9740;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__9734){
var vec__9735 = p__9734;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__9735,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq9732){
var G__9733 = cljs.core.first.call(null,seq9732);
var seq9732__$1 = cljs.core.next.call(null,seq9732);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__9733,seq9732__$1);
});
...
var map__9743 = options;
var map__9743__$1 = (((((!((map__9743 == null))))?(((((map__9743.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__9743.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.call(null,cljs.core.hash_map,map__9743):map__9743);
var include_ns_QMARK_ = cljs.core.get.call(null,map__9743__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__9743__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__9743__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__9743__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__9744 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__9744,(0),null);
var fn_name = cljs.core.nth.call(null,vec__9744,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__9744,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__9744,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__9744,(4),null);
var arity = cljs.core.nth.call(null,vec__9744,(5),null);
...
var o__8773__auto__ = f;
return (o__8773__auto__["getBasis"]).call(o__8773__auto__);
});
/**
...
}catch (e9748){var _e__8780__auto__ = e9748;
...
var G__9749 = (obj[cljs.core.first.call(null,path)]);
var G__9750 = cljs.core.rest.call(null,path);
obj = G__9749;
path = G__9750;
continue;
} else {
...
return (function (accum,p__9751){
var vec__9752 = p__9751;
var bit = cljs.core.nth.call(null,vec__9752,(0),null);
var protocol = cljs.core.nth.call(null,vec__9752,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__9755){
var vec__9756 = p__9755;
var ns = cljs.core.nth.call(null,vec__9756,(0),null);
var name = cljs.core.nth.call(null,vec__9756,(1),null);
var selector = cljs.core.nth.call(null,vec__9756,(2),null);
...
return (function (p__9760){
var vec__9761 = p__9760;
var munged_name = cljs.core.nth.call(null,vec__9761,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__9761,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__9761,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__9759_SHARP_){
return (obj[cljs.core.first.call(null,p1__9759_SHARP_)]);
});})(name,sorted_matches,vec__9761,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
