...
var G__9766 = devtools.prefs.pref.call(null,v);
v = G__9766;
continue;
} else {
return v;
...
}catch (e9769){var _e__8780__auto__ = e9769;
return false;
}})();
...
}catch (e9773){var _e__8780__auto__ = e9773;
return false;
}})();
...
}catch (e9775){var _e__8780__auto__ = e9775;
return false;
}}
}
});
...
var vec__9777 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__9777,(0),null);
var name = cljs.core.nth.call(null,vec__9777,(1),null);
...
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__9780_SHARP_);
}),template);
});
