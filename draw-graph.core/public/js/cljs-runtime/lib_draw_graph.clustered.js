...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36465_SHARP_){
return lib_draw_graph$clustered$cluster_descendants_$_descend(p1__36465_SHARP_,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,clstr));
}),children);
}
});
...
var attr = (function (){var G__36474 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"clusters","clusters",273881275).cljs$core$IFn$_invoke$arity$1(g)),cluster);
return (sub_key.cljs$core$IFn$_invoke$arity$1 ? sub_key.cljs$core$IFn$_invoke$arity$1(G__36474) : sub_key.call(null,G__36474));
})();
if(cljs.core.truth_(attr)){
return attr;
} else {
var temp__5733__auto__ = lib_draw_graph.clustered.cluster_parent(g,cluster);
...
if(cljs.core.truth_(temp__5733__auto__)){
var parent = temp__5733__auto__;
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(lib_draw_graph.clustered.merged_cluster_attr.cljs$core$IFn$_invoke$arity$3 ? lib_draw_graph.clustered.merged_cluster_attr.cljs$core$IFn$_invoke$arity$3(g,parent,sub_key) : lib_draw_graph.clustered.merged_cluster_attr.call(null,g,parent,sub_key)),(function (){var G__36479 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"clusters","clusters",273881275).cljs$core$IFn$_invoke$arity$1(g)),cluster);
return (sub_key.cljs$core$IFn$_invoke$arity$1 ? sub_key.cljs$core$IFn$_invoke$arity$1(G__36479) : sub_key.call(null,G__36479));
})()], 0));
} else {
var G__36483 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"clusters","clusters",273881275).cljs$core$IFn$_invoke$arity$1(g)),cluster);
return (sub_key.cljs$core$IFn$_invoke$arity$1 ? sub_key.cljs$core$IFn$_invoke$arity$1(G__36483) : sub_key.call(null,G__36483));
}
});
/**
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__36484_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cluster,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__36484_SHARP_,lib_draw_graph.clustered.__GT_keyword(cluster_on)));
}),loom.graph.nodes(g));
}));
...
var children = (function lib_draw_graph$clustered$children(clstr,acc){
...
if((!((chds == null)))){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36496_SHARP_){
return lib_draw_graph$clustered$children(p1__36496_SHARP_,acc__$1);
}),chds);
} else {
return acc__$1;
}
...
var temp__5733__auto__ = lib_draw_graph.clustered.cluster_parent(g,cljs.core.first(acc));
if(cljs.core.truth_(temp__5733__auto__)){
var new_ancestor = temp__5733__auto__;
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(clojure.set.union,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36526_SHARP_){
return lib_draw_graph.clustered.node__GT_clusters.cljs$core$IFn$_invoke$arity$2(g,p1__36526_SHARP_);
}),nds));
});
/**
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (a,p__36538){
var vec__36539 = p__36538;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36539,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36539,(1),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (a,p__36544){
...
var len__4789__auto___36684 = arguments.length;
var i__4790__auto___36685 = (0);
while(true){
if((i__4790__auto___36685 < len__4789__auto___36684)){
args__4795__auto__.push((arguments[i__4790__auto___36685]));

var G__36686 = (i__4790__auto___36685 + (1));
i__4790__auto___36685 = G__36686;
continue;
} else {
}
break;
...
return lib_draw_graph.clustered.remove_clusters.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4796__auto__);
});
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(g,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"clusters","clusters",273881275),new cljs.core.Keyword(null,"attr","attr",-604132353)], null),(function (p1__36550_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__36550_SHARP_,clstrs);
...
/** @this {Function} */
(lib_draw_graph.clustered.remove_clusters.cljs$lang$applyTo = (function (seq36551){
var G__36552 = cljs.core.first(seq36551);
var seq36551__$1 = cljs.core.next(seq36551);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36552,seq36551__$1);
}));
