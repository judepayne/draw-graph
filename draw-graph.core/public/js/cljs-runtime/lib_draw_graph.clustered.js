...
return lib_draw_graph$clustered$cluster_descendants_$_descend(p1__35648_SHARP_,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,clstr));
});})(children))
,children);
}
});
...
return lib_draw_graph$clustered$children(p1__35661_SHARP_,acc__$1);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(clojure.set.union,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__35684_SHARP_){
return lib_draw_graph.clustered.node__GT_clusters.cljs$core$IFn$_invoke$arity$2(g,p1__35684_SHARP_);
}),nds));
});
/**
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (a,p__35692){
...
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35703,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35703,(1),null);
...
while(true){
if((i__4731__auto___35790 < len__4730__auto___35788)){
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__35706_SHARP_,clstrs);
});})(clstrs_set))
...
/** @this {Function} */
lib_draw_graph.clustered.remove_clusters.cljs$lang$applyTo = (function (seq35708){
