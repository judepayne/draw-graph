...
var G__34665 = old;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__34665)){
...
return lib_draw_graph$clustered$cluster_descendants_$_descend(p1__34674_SHARP_,cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,clstr));
});})(children))
,children);
}
});
...
var attr = (function (){var G__34679 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"clusters","clusters",273881275).cljs$core$IFn$_invoke$arity$1(g)),cluster);
return (sub_key.cljs$core$IFn$_invoke$arity$1 ? sub_key.cljs$core$IFn$_invoke$arity$1(G__34679) : sub_key.call(null,G__34679));
})();
...
if(cljs.core.truth_(temp__5718__auto__)){
var parent = temp__5718__auto__;
return cljs.core.merge.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([(lib_draw_graph.clustered.merged_cluster_attr.cljs$core$IFn$_invoke$arity$3 ? lib_draw_graph.clustered.merged_cluster_attr.cljs$core$IFn$_invoke$arity$3(g,parent,sub_key) : lib_draw_graph.clustered.merged_cluster_attr.call(null,g,parent,sub_key)),(function (){var G__34682 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"clusters","clusters",273881275).cljs$core$IFn$_invoke$arity$1(g)),cluster);
return (sub_key.cljs$core$IFn$_invoke$arity$1 ? sub_key.cljs$core$IFn$_invoke$arity$1(G__34682) : sub_key.call(null,G__34682));
})()], 0));
} else {
var G__34684 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"attr","attr",-604132353).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"clusters","clusters",273881275).cljs$core$IFn$_invoke$arity$1(g)),cluster);
return (sub_key.cljs$core$IFn$_invoke$arity$1 ? sub_key.cljs$core$IFn$_invoke$arity$1(G__34684) : sub_key.call(null,G__34684));
}
});
/**
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__34688_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cluster,cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__34688_SHARP_,lib_draw_graph.clustered.__GT_keyword(cluster_on)));
}),loom.graph.nodes(g));
});
...
return lib_draw_graph$clustered$children(p1__34710_SHARP_,acc__$1);
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(clojure.set.union,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__34755_SHARP_){
return lib_draw_graph.clustered.node__GT_clusters.cljs$core$IFn$_invoke$arity$2(g,p1__34755_SHARP_);
}),nds));
});
/**
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (a,p__34758){
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (a,p__34766){
...
var len__4730__auto___34840 = arguments.length;
var i__4731__auto___34841 = (0);
while(true){
if((i__4731__auto___34841 < len__4730__auto___34840)){
args__4736__auto__.push((arguments[i__4731__auto___34841]));

var G__34842 = (i__4731__auto___34841 + (1));
i__4731__auto___34841 = G__34842;
continue;
} else {
}
break;
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc,p1__34771_SHARP_,clstrs);
});})(clstrs_set))
...
/** @this {Function} */
lib_draw_graph.clustered.remove_clusters.cljs$lang$applyTo = (function (seq34772){
var G__34773 = cljs.core.first(seq34772);
var seq34772__$1 = cljs.core.next(seq34772);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__34773,seq34772__$1);
});
