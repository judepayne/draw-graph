...
if((i < len)){
var k = (ks[i]);
var G__35958 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__35959 = (i + (1));
m = G__35958;
i = G__35959;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__35824 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__35824);
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35831 = c;
var G__35831__$1 = (((G__35831 == null))?null:G__35831.prototype);
if((G__35831__$1 == null)){
return null;
} else {
return (G__35831__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35842 = c;
var G__35842__$1 = (((G__35842 == null))?null:G__35842.prototype);
if((G__35842__$1 == null)){
return null;
} else {
return (G__35842__$1["render"]);
}
})() == null)))));
});
...
var G__35862 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__35862) : reagent.impl.component.as_element.call(null,G__35862));
};
...
return ((function (G__35871,G__35871__$1){
...
var c = this;
var G__35881_35994 = (c["cljsRatom"]);
if((G__35881_35994 == null)){
} else {
reagent.ratom.dispose_BANG_(G__35881_35994);
}
...
var renders_35995 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_35996 = cljs.core.first(cljs.core.vals(renders_35995));
if((cljs.core.count(renders_35995) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_35995))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_35996)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_35996], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__35882 = name;
switch (G__35882) {
case "":
...
var G__35885 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__35885);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__35890 = fiber;
var G__35890__$1 = (((G__35890 == null))?null:(G__35890["type"]));
if((G__35890__$1 == null)){
return null;
} else {
return (G__35890__$1["displayName"]);
}
})();
var parent = (function (){var G__35899 = fiber;
if((G__35899 == null)){
return null;
} else {
return (G__35899["return"]);
}
})();
var path = (function (){var G__35916 = parent;
var G__35916__$1 = (((G__35916 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__35916) : reagent.impl.component.fiber_component_path.call(null,G__35916)));
if((G__35916__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35916__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__35933 = c;
if((G__35933 == null)){
return null;
} else {
return (G__35933["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__35937._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__35939 = c;
if((G__35939 == null)){
return null;
} else {
return (G__35939["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__35941 = c;
if((G__35941 == null)){
return null;
} else {
return G__35941._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4131__auto__ = (function (){var G__35943 = instance;
if((G__35943 == null)){
return null;
} else {
return (G__35943["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__35944 = instance;
if((G__35944 == null)){
return null;
} else {
return G__35944._currentElement;
}
}
})();
var name = (function (){var G__35945 = elem;
var G__35945__$1 = (((G__35945 == null))?null:(G__35945["type"]));
if((G__35945__$1 == null)){
return null;
} else {
return (G__35945__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__35947 = elem;
if((G__35947 == null)){
return null;
} else {
return (G__35947["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__35948._owner;
}
}
})();
var path = (function (){var G__35949 = owner;
var G__35949__$1 = (((G__35949 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__35949) : reagent.impl.component.component_path.call(null,G__35949)));
if((G__35949__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35949__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__35950 = c;
var G__35950__$1 = (((G__35950 == null))?null:G__35950.constructor);
if((G__35950__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__35950__$1);
}
}
})();
