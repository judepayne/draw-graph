...
if((i < len)){
var k = (ks[i]);
var G__35995 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__35996 = (i + (1));
m = G__35995;
i = G__35996;
continue;
...
var temp__5722__auto__ = (p["argv"]);
if((temp__5722__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__35844 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__35844);
})());
} else {
var v = temp__5722__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35849 = c;
var G__35849__$1 = (((G__35849 == null))?null:G__35849.prototype);
if((G__35849__$1 == null)){
return null;
} else {
return (G__35849__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__35858 = c;
var G__35858__$1 = (((G__35858 == null))?null:G__35858.prototype);
if((G__35858__$1 == null)){
return null;
} else {
return (G__35858__$1["render"]);
}
})() == null)))));
});
...
var G__35865 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__35865) : reagent.impl.component.as_element.call(null,G__35865));
};
...
var _STAR_current_component_STAR__orig_val__35868 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__35869 = c;
reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__35869;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__35868;
}});
...
var G__35876 = key;
var G__35876__$1 = (((G__35876 instanceof cljs.core.Keyword))?G__35876.fqn:null);
switch (G__35876__$1) {
...
return ((function (G__35876,G__35876__$1){
...
var c = this;
var G__35881_36005 = (c["cljsRatom"]);
if((G__35881_36005 == null)){
} else {
reagent.ratom.dispose_BANG_(G__35881_36005);
}
...
var renders_36007 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_36008 = cljs.core.first(cljs.core.vals(renders_36007));
if((cljs.core.count(renders_36007) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_36007))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_36008)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_36008], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__35911 = name;
switch (G__35911) {
case "":
...
var G__35931 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__35931);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__35932 = fiber;
var G__35932__$1 = (((G__35932 == null))?null:(G__35932["type"]));
if((G__35932__$1 == null)){
return null;
} else {
return (G__35932__$1["displayName"]);
}
})();
var parent = (function (){var G__35933 = fiber;
if((G__35933 == null)){
return null;
} else {
return (G__35933["return"]);
}
})();
var path = (function (){var G__35934 = parent;
var G__35934__$1 = (((G__35934 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__35934) : reagent.impl.component.fiber_component_path.call(null,G__35934)));
if((G__35934__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35934__$1)," > "].join('');
}
})();
...
var temp__5718__auto__ = (function (){var or__4131__auto__ = (function (){var G__35959 = c;
if((G__35959 == null)){
return null;
} else {
return (G__35959["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
return G__35961._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4131__auto__ = (function (){var G__35965 = c;
if((G__35965 == null)){
return null;
} else {
return (G__35965["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var or__4131__auto____$1 = (function (){var G__35967 = c;
if((G__35967 == null)){
return null;
} else {
...
var elem = (function (){var or__4131__auto__ = (function (){var G__35969 = instance;
if((G__35969 == null)){
return null;
} else {
return (G__35969["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
var G__35970 = instance;
if((G__35970 == null)){
return null;
} else {
return G__35970._currentElement;
}
}
})();
var name = (function (){var G__35971 = elem;
var G__35971__$1 = (((G__35971 == null))?null:(G__35971["type"]));
if((G__35971__$1 == null)){
return null;
} else {
return (G__35971__$1["displayName"]);
}
})();
var owner = (function (){var or__4131__auto__ = (function (){var G__35973 = elem;
if((G__35973 == null)){
return null;
} else {
return (G__35973["_owner"]);
}
})();
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
...
var path = (function (){var G__35976 = owner;
var G__35976__$1 = (((G__35976 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__35976) : reagent.impl.component.component_path.call(null,G__35976)));
if((G__35976__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__35976__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__35981 = c;
var G__35981__$1 = (((G__35981 == null))?null:G__35981.constructor);
if((G__35981__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__35981__$1);
}
}
})();
