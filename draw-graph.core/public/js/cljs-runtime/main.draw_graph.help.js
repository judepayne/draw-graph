goog.provide('main.draw_graph.help');
...
main.draw_graph.help.rand_rects_STAR_ = (function main$draw_graph$help$rand_rects_STAR_(bdry,sep){
return (new cljs.core.LazySeq(null,(function (){
return cljs.core.cons(main.draw_graph.help.rand_rect(bdry),(main.draw_graph.help.rand_rects_STAR_.cljs$core$IFn$_invoke$arity$1 ? main.draw_graph.help.rand_rects_STAR_.cljs$core$IFn$_invoke$arity$1(bdry) : main.draw_graph.help.rand_rects_STAR_.call(null,bdry)));
}),null,null));
});
main.draw_graph.help.rand_rects = (function main$draw_graph$help$rand_rects(n,bdry,sep){
...
if(((cljs.core.not_any_QMARK_((function (p1__52245_SHARP_){
var fexpr__52248 = cljs.core.partial.cljs$core$IFn$_invoke$arity$3(lib_draw_graph.geometry.overlaps_QMARK_,sep,cljs.core.first(cljs.core.vals(c)));
return (fexpr__52248.cljs$core$IFn$_invoke$arity$1 ? fexpr__52248.cljs$core$IFn$_invoke$arity$1(p1__52245_SHARP_) : fexpr__52248.call(null,p1__52245_SHARP_));
...
}),cljs.core.PersistentArrayMap.EMPTY,cljs.core.take.cljs$core$IFn$_invoke$arity$2((n + (30)),main.draw_graph.help.rand_rects_STAR_(bdry,sep)));
});
main.draw_graph.help.timeout = (function main$draw_graph$help$timeout(ms){
...
main.draw_graph.help.state = reagent.core.atom.cljs$core$IFn$_invoke$arity$1(new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"running","running",1554969103),false], null));
main.draw_graph.help.rect = (function main$draw_graph$help$rect(var_args){
var args__4736__auto__ = [];
var len__4730__auto___52356 = arguments.length;
var i__4731__auto___52357 = (0);
while(true){
if((i__4731__auto___52357 < len__4730__auto___52356)){
args__4736__auto__.push((arguments[i__4731__auto___52357]));

var G__52358 = (i__4731__auto___52357 + (1));
i__4731__auto___52357 = G__52358;
continue;
} else {
}
break;
...
return main.draw_graph.help.rect.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__4737__auto__);
});

main.draw_graph.help.rect.cljs$core$IFn$_invoke$arity$variadic = (function (r,p__52257){
...
var fill_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__52258__$1,new cljs.core.Keyword(null,"fill?","fill?",-485702148),false);
...
main.draw_graph.help.rect.cljs$lang$maxFixedArity = (1);

/** @this {Function} */
main.draw_graph.help.rect.cljs$lang$applyTo = (function (seq52252){
var G__52253 = cljs.core.first(seq52252);
var seq52252__$1 = cljs.core.next(seq52252);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__52253,seq52252__$1);
});

main.draw_graph.help.gen_rects = (function main$draw_graph$help$gen_rects(){
return main.draw_graph.help.rand_rects(((4) + cljs.core.rand_int((7))),main.draw_graph.help.inner_boundary,(5));
});
main.draw_graph.help.rects__GT_svg = (function main$draw_graph$help$rects__GT_svg(state,filled_QMARK_){
if(cljs.core.truth_(filled_QMARK_)){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52263_SHARP_){
return main.draw_graph.help.rect.cljs$core$IFn$_invoke$arity$variadic(p1__52263_SHARP_,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"fill?","fill?",-485702148),filled_QMARK_], 0));
}),cljs.core.vals(state));
} else {
return cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__52264_SHARP_){
return main.draw_graph.help.rect(p1__52264_SHARP_);
}),cljs.core.vals(state));
}
});
main.draw_graph.help.constraints = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"boundary","boundary",-2000996754),main.draw_graph.help.inner_boundary,new cljs.core.Keyword(null,"collision","collision",-201625508),main.draw_graph.help.sep,new cljs.core.Keyword(null,"grow","grow",-524118895),true], null);
main.draw_graph.help.log = console.log;
main.draw_graph.help.a = (function main$draw_graph$help$a(n){
if(cljs.core.truth_(new cljs.core.Keyword(null,"running","running",1554969103).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(main.draw_graph.help.state)))){
return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(main.draw_graph.help.state,cljs.core.assoc,new cljs.core.Keyword(null,"state","state",-1988618099),lib_draw_graph.anneal.annealing.cljs$core$IFn$_invoke$arity$variadic(new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(main.draw_graph.help.state)),n,(0),new cljs.core.Keyword(null,"constraints","constraints",422775616).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(main.draw_graph.help.state)),lib_draw_graph.anneal.neighbor_fn,lib_draw_graph.anneal.cost_fn,lib_draw_graph.anneal.p_fn,lib_draw_graph.anneal.temp_fn,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"dims","dims",-466522889),new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"x","x",2099068185),new cljs.core.Keyword(null,"y","y",-1757859776),new cljs.core.Keyword(null,"w","w",354169001),new cljs.core.Keyword(null,"h","h",1109658740)], null)], 0)));
} else {
return null;
}
});
main.draw_graph.help.anneal = (function main$draw_graph$help$anneal(){
...
return (function (state_52292){
var state_val_52293 = (state_52292[(1)]);
if((state_val_52293 === (1))){
var inst_52272 = (0);
var state_52292__$1 = (function (){var statearr_52304 = state_52292;
(statearr_52304[(7)] = inst_52272);

return statearr_52304;
})();
var statearr_52305_52380 = state_52292__$1;
(statearr_52305_52380[(2)] = null);

(statearr_52305_52380[(1)] = (2));


return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_52293 === (2))){
var inst_52272 = (state_52292[(7)]);
var inst_52274 = (inst_52272 < (72));
var state_52292__$1 = state_52292;
if(cljs.core.truth_(inst_52274)){
var statearr_52310_52385 = state_52292__$1;
(statearr_52310_52385[(1)] = (4));

} else {
var statearr_52311_52387 = state_52292__$1;
(statearr_52311_52387[(1)] = (5));
...
var inst_52277 = main.draw_graph.help.a((100));
var inst_52278 = main.draw_graph.help.timeout((40));
var state_52292__$1 = (function (){var statearr_52316 = state_52292;
(statearr_52316[(8)] = inst_52277);

return statearr_52316;
})();
return cljs.core.async.impl.ioc_helpers.take_BANG_(state_52292__$1,(7),inst_52278);
} else {
if((state_val_52293 === (5))){
var state_52292__$1 = state_52292;
var statearr_52318_52392 = state_52292__$1;
(statearr_52318_52392[(2)] = null);

(statearr_52318_52392[(1)] = (6));


return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_52293 === (6))){
var inst_52288 = (state_52292[(2)]);
var state_52292__$1 = state_52292;
var statearr_52322_52393 = state_52292__$1;
(statearr_52322_52393[(2)] = inst_52288);

(statearr_52322_52393[(1)] = (3));


return new cljs.core.Keyword(null,"recur","recur",-437573268);
} else {
if((state_val_52293 === (7))){
var inst_52272 = (state_52292[(7)]);
var inst_52280 = (state_52292[(2)]);
var inst_52284 = (inst_52272 + (1));
var inst_52272__$1 = inst_52284;
var state_52292__$1 = (function (){var statearr_52323 = state_52292;
(statearr_52323[(7)] = inst_52272__$1);

(statearr_52323[(9)] = inst_52280);

return statearr_52323;
})();
var statearr_52324_52394 = state_52292__$1;
(statearr_52324_52394[(2)] = null);

(statearr_52324_52394[(1)] = (2));
...
return (function() {
var main$draw_graph$help$anneal_$_state_machine__25088__auto__ = null;
var main$draw_graph$help$anneal_$_state_machine__25088__auto____0 = (function (){
var statearr_52325 = [null,null,null,null,null,null,null,null,null,null];
(statearr_52325[(0)] = main$draw_graph$help$anneal_$_state_machine__25088__auto__);

(statearr_52325[(1)] = (1));

return statearr_52325;
});
var main$draw_graph$help$anneal_$_state_machine__25088__auto____1 = (function (state_52292){
while(true){
var ret_value__25089__auto__ = (function (){try{while(true){
var result__25090__auto__ = switch__25087__auto__(state_52292);
...
}catch (e52326){if((e52326 instanceof Object)){
var ex__25091__auto__ = e52326;
var statearr_52327_52396 = state_52292;
(statearr_52327_52396[(5)] = ex__25091__auto__);


cljs.core.async.impl.ioc_helpers.process_exception(state_52292);
...
var G__52400 = state_52292;
state_52292 = G__52400;
continue;
} else {
...
main$draw_graph$help$anneal_$_state_machine__25088__auto__ = function(state_52292){
switch(arguments.length){
case 0:
return main$draw_graph$help$anneal_$_state_machine__25088__auto____0.call(this);
case 1:
return main$draw_graph$help$anneal_$_state_machine__25088__auto____1.call(this,state_52292);
}
throw(new Error('Invalid arity: ' + arguments.length));
};
main$draw_graph$help$anneal_$_state_machine__25088__auto__.cljs$core$IFn$_invoke$arity$0 = main$draw_graph$help$anneal_$_state_machine__25088__auto____0;
main$draw_graph$help$anneal_$_state_machine__25088__auto__.cljs$core$IFn$_invoke$arity$1 = main$draw_graph$help$anneal_$_state_machine__25088__auto____1;
return main$draw_graph$help$anneal_$_state_machine__25088__auto__;
})()
;})(switch__25087__auto__,c__25132__auto__))
})();
var state__25134__auto__ = (function (){var statearr_52328 = (f__25133__auto__.cljs$core$IFn$_invoke$arity$0 ? f__25133__auto__.cljs$core$IFn$_invoke$arity$0() : f__25133__auto__.call(null));
(statearr_52328[(6)] = c__25132__auto__);
...
main.draw_graph.help.generate = (function main$draw_graph$help$generate(){
var rects = main.draw_graph.help.gen_rects();
...
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(main.draw_graph.help.state,cljs.core.assoc,new cljs.core.Keyword(null,"state","state",-1988618099),st);

cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(main.draw_graph.help.state,cljs.core.assoc,new cljs.core.Keyword(null,"running","running",1554969103),false);

return cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(main.draw_graph.help.state,cljs.core.assoc,new cljs.core.Keyword(null,"constraints","constraints",422775616),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(main.draw_graph.help.constraints,new cljs.core.Keyword(null,"obstacles","obstacles",1370670211),obs));
});
main.draw_graph.help.anneal_demo = (function main$draw_graph$help$anneal_demo(){
return (function (){
return new cljs.core.PersistentVector(null, 4, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.anneal-demo","div.anneal-demo",-437253449),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"svg","svg",856789142),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"x","x",2099068185),(0),new cljs.core.Keyword(null,"y","y",-1757859776),(0),new cljs.core.Keyword(null,"width","width",-384071477),(600),new cljs.core.Keyword(null,"height","height",1025178622),(400)], null),main.draw_graph.help.rect(main.draw_graph.help.boundary),main.draw_graph.help.rects__GT_svg(new cljs.core.Keyword(null,"state","state",-1988618099).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(main.draw_graph.help.state)),false),main.draw_graph.help.rects__GT_svg(new cljs.core.Keyword(null,"obstacles","obstacles",1370670211).cljs$core$IFn$_invoke$arity$1(new cljs.core.Keyword(null,"constraints","constraints",422775616).cljs$core$IFn$_invoke$arity$1(cljs.core.deref(main.draw_graph.help.state))),true)], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"button",new cljs.core.Keyword(null,"value","value",305978217),"Generate",new cljs.core.Keyword(null,"on-click","on-click",1632826543),main.draw_graph.help.generate], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"input","input",556931961),new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"type","type",1174270348),"button",new cljs.core.Keyword(null,"value","value",305978217),"Anneal!",new cljs.core.Keyword(null,"on-click","on-click",1632826543),(function (){
cljs.core.swap_BANG_.cljs$core$IFn$_invoke$arity$4(main.draw_graph.help.state,cljs.core.assoc,new cljs.core.Keyword(null,"running","running",1554969103),true);

return main.draw_graph.help.anneal();
})], null)], null)], null);
});
});
main.draw_graph.help.help_page = (function main$draw_graph$help$help_page(){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div.block-text","div.block-text",1029445422),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),main.draw_graph.utils.md__GT_hiccup(main.draw_graph.help.section_1)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),"(slowed down ~50x. Obstacles shown as filled rectangles.)"], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"div","div",1057191632),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [main.draw_graph.help.anneal_demo], null)], null),new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"p","p",151049309),main.draw_graph.utils.md__GT_hiccup(main.draw_graph.help.section_2)], null)], null);
});

//# sourceMappingURL=main.draw_graph.help.js.map
