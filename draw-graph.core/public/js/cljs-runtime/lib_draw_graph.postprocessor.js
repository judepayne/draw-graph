...
return (!((lib_draw_graph.clustered.cluster_children(g,p1__36422_SHARP_) == null)));
});})(clstrs))
,clstrs);
...
return (function (p1__36436_SHARP_,p2__36437_SHARP_){
if(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__36436_SHARP_,p2__36437_SHARP_))){
return p1__36436_SHARP_;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__36436_SHARP_,p2__36437_SHARP_,cljs.core.PersistentHashSet.EMPTY);
}
});})(have_incoming))
,g,have_incoming);
});
...
var vec__36442 = lib_draw_graph.postprocessor.take_1(s);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36442,(0),null);
var s_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36442,(1),null);
var m = (g.cljs$core$IFn$_invoke$arity$1 ? g.cljs$core$IFn$_invoke$arity$1(n) : g.call(null,n));
var g_SINGLEQUOTE_ = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (g,l,s,vec__36442,n,s_SINGLEQUOTE_,m){
return (function (p1__36438_SHARP_,p2__36439_SHARP_){
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$4(p1__36438_SHARP_,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [n], null),lib_draw_graph.postprocessor.without,p2__36439_SHARP_);
});})(g,l,s,vec__36442,n,s_SINGLEQUOTE_,m))
,g,m);
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__36446_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__36446_SHARP_,lib_draw_graph.clustered.cluster_children(g,p1__36446_SHARP_)],null));
}),clstrs);
});
/**
...
/** @this {Function} */
lib_draw_graph.postprocessor.sep.cljs$lang$applyTo = (function (seq36448){
...
lib_draw_graph.postprocessor.adjust_sep.cljs$core$IFn$_invoke$arity$variadic = (function (sep,p__36456){
...
var cluster_sep = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36458__$1,new cljs.core.Keyword(null,"cluster-sep","cluster-sep",127315253),null);
var BT_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36458__$1,new cljs.core.Keyword(null,"BT?","BT?",664855515),false);
...
/** @this {Function} */
lib_draw_graph.postprocessor.adjust_sep.cljs$lang$applyTo = (function (seq36454){
var G__36455 = cljs.core.first(seq36454);
var seq36454__$1 = cljs.core.next(seq36454);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36455,seq36454__$1);
});
...
}catch (e36471){if((e36471 instanceof Error)){
var e = e36471;
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(rects,p1__36472_SHARP_);
...
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__36473_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(rects,p1__36473_SHARP_)],null));
...
var adj_env = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (new_st,vec__36485,k,v,env,rankdir,y_retard,x_retard,dims){
return (function (acc,p__36488){
var vec__36490 = p__36488;
...
});})(new_st,vec__36485,k,v,env,rankdir,y_retard,x_retard,dims))
,a,new_st);
