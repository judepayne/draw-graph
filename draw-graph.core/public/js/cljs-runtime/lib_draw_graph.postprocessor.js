...
return (!((lib_draw_graph.clustered.cluster_children(g,p1__36449_SHARP_) == null)));
});})(clstrs))
,clstrs);
...
if(cljs.core.truth_(cljs.core.get.cljs$core$IFn$_invoke$arity$2(p1__36468_SHARP_,p2__36469_SHARP_))){
return p1__36468_SHARP_;
} else {
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__36468_SHARP_,p2__36469_SHARP_,cljs.core.PersistentHashSet.EMPTY);
}
});})(have_incoming))
,g,have_incoming);
});
...
var vec__36474 = lib_draw_graph.postprocessor.take_1(s);
var n = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36474,(0),null);
var s_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36474,(1),null);
var m = (g.cljs$core$IFn$_invoke$arity$1 ? g.cljs$core$IFn$_invoke$arity$1(n) : g.call(null,n));
var g_SINGLEQUOTE_ = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (g,l,s,vec__36474,n,s_SINGLEQUOTE_,m){
...
});})(g,l,s,vec__36474,n,s_SINGLEQUOTE_,m))
,g,m);
var G__36529 = g_SINGLEQUOTE_;
var G__36530 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(l,n);
var G__36531 = clojure.set.union.cljs$core$IFn$_invoke$arity$2(s_SINGLEQUOTE_,clojure.set.intersection.cljs$core$IFn$_invoke$arity$2(lib_draw_graph.postprocessor.no_incoming(g_SINGLEQUOTE_),m));
g = G__36529;
l = G__36530;
s = G__36531;
continue;
...
return cljs.core.mapv.cljs$core$IFn$_invoke$arity$2((function (p1__36477_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__36477_SHARP_,lib_draw_graph.clustered.cluster_children(g,p1__36477_SHARP_)],null));
}),clstrs);
});
/**
...
/** @this {Function} */
lib_draw_graph.postprocessor.sep.cljs$lang$applyTo = (function (seq36478){
...
lib_draw_graph.postprocessor.adjust_sep.cljs$core$IFn$_invoke$arity$variadic = (function (sep,p__36488){
...
var cluster_sep = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36489__$1,new cljs.core.Keyword(null,"cluster-sep","cluster-sep",127315253),null);
var BT_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36489__$1,new cljs.core.Keyword(null,"BT?","BT?",664855515),false);
...
/** @this {Function} */
lib_draw_graph.postprocessor.adjust_sep.cljs$lang$applyTo = (function (seq36482){
...
}catch (e36495){if((e36495 instanceof Error)){
var e = e36495;
...
return (function (a,p__36499){
var vec__36501 = p__36499;
var prnt = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36501,(0),null);
var chdn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36501,(1),null);
var p_rect = cljs.core.get.cljs$core$IFn$_invoke$arity$2(rects,prnt);
var c_rects = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (p_rect,vec__36501,prnt,chdn,cluster_sep,BT_QMARK_,tasks,clstrs,rects){
return (function (p1__36496_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(rects,p1__36496_SHARP_);
});})(p_rect,vec__36501,prnt,chdn,cluster_sep,BT_QMARK_,tasks,clstrs,rects))
,chdn);
...
var state = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (p_rect,c_rects,sep,vec__36501,prnt,chdn,cluster_sep,BT_QMARK_,tasks,clstrs,rects){
return (function (p1__36497_SHARP_){
return (new cljs.core.PersistentVector(null,2,(5),cljs.core.PersistentVector.EMPTY_NODE,[p1__36497_SHARP_,cljs.core.get.cljs$core$IFn$_invoke$arity$2(rects,p1__36497_SHARP_)],null));
});})(p_rect,c_rects,sep,vec__36501,prnt,chdn,cluster_sep,BT_QMARK_,tasks,clstrs,rects))
,chdn));
var constr = new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"boundary","boundary",-2000996754),lib_draw_graph.geometry.inner_rect(sep,p_rect),new cljs.core.Keyword(null,"grow","grow",-524118895),true,new cljs.core.Keyword(null,"collision","collision",-201625508),(cljs.core.truth_(cluster_sep)?cluster_sep:lib_draw_graph.postprocessor.collision_sep),new cljs.core.Keyword(null,"obstacles","obstacles",1370670211),cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (p_rect,c_rects,sep,state,vec__36501,prnt,chdn,cluster_sep,BT_QMARK_,tasks,clstrs,rects){
...
});})(p_rect,c_rects,sep,state,vec__36501,prnt,chdn,cluster_sep,BT_QMARK_,tasks,clstrs,rects))
...
var vec__36512 = p__36510;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36512,(0),null);
...
var adj_env = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (new_st,vec__36519,k,v,env,rankdir,y_retard,x_retard,dims){
return (function (acc,p__36522){
var vec__36523 = p__36522;
var k_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36523,(0),null);
var v_SINGLEQUOTE_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36523,(1),null);
...
});})(new_st,vec__36519,k,v,env,rankdir,y_retard,x_retard,dims))
,a,new_st);
...
if(cljs.core.truth_(temp__5718__auto__)){
var edited = temp__5718__auto__;
var G__36526 = new cljs.core.Keyword(null,"labeljust","labeljust",-370267851).cljs$core$IFn$_invoke$arity$1(lib_draw_graph.clustered.merged_cluster_attr(g,clstr,new cljs.core.Keyword(null,"style","style",-496642736)));
switch (G__36526) {
case "l":
...
if(cljs.core.truth_(temp__5718__auto__)){
var edited = temp__5718__auto__;
var G__36527 = new cljs.core.Keyword(null,"labeljust","labeljust",-370267851).cljs$core$IFn$_invoke$arity$1(lib_draw_graph.clustered.merged_cluster_attr(g,clstr,new cljs.core.Keyword(null,"style","style",-496642736)));
switch (G__36527) {
case "l":
