...
var vec__53934 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53934,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53934,(1),null);
...
var vec__53937 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53937,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53937,(1),null);
if(cljs.core.truth_(end)){
return cljs.core.long$(end);
} else {
...
var vec__53940 = instaparse.viz.span(parse);
var start = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53940,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53940,(1),null);
...
var G__54092 = cljs.core.next(parses__$1);
parses__$1 = G__54092;
continue;
}
...
var G__53948 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__53950 = G__53948;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53950,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53950,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53950,(2),null);
var selection = vec__53950;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__53948__$1 = G__53948;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__53957 = G__53948__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53957,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53957,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53957,(2),null);
var selection__$1 = vec__53957;
...
var G__54110 = cljs.core.long$(end__$1);
var G__54111 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__54112 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__54110;
parses__$1 = G__54111;
G__53948__$1 = G__54112;
continue;
...
var G__53971 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__53974 = G__53971;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53974,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53974,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53974,(2),null);
var selection = vec__53974;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__53971__$1 = G__53971;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__53988 = G__53971__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53988,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53988,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53988,(2),null);
var selection__$1 = vec__53988;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__54159 = cljs.core.long$(end__$1);
var G__54160 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__54161 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__54159;
parses__$1 = G__54160;
G__53971__$1 = G__54161;
continue;
...
var index__$1 = cljs.core.long$(index);
var parses = instaparse.auto_flatten_seq.EMPTY;
var G__54006 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,index__$1,first_result);
var vec__54011 = G__54006;
var parse = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54011,(0),null);
var end = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54011,(1),null);
var follow_ups = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54011,(2),null);
var selection = vec__54011;
var index__$2 = index__$1;
var parses__$1 = parses;
var G__54006__$1 = G__54006;
while(true){
var index__$3 = index__$2;
var parses__$2 = parses__$1;
var vec__54020 = G__54006__$1;
var parse__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54020,(0),null);
var end__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54020,(1),null);
var follow_ups__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__54020,(2),null);
var selection__$1 = vec__54020;
if((selection__$1 == null)){
return instaparse.repeat.failure_signal;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(index__$3,end__$1)){
...
var G__54186 = cljs.core.long$(end__$1);
var G__54187 = instaparse.auto_flatten_seq.conj_flat(parses__$2,parse__$1);
var G__54188 = instaparse.repeat.select_parse(grammar,initial_parser,text,segment,end__$1,follow_ups__$1);
index__$2 = G__54186;
parses__$1 = G__54187;
G__54006__$1 = G__54188;
continue;
...
if(cljs.core.truth_((function (){var fexpr__54043 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"hiccup","hiccup",1218876238),null,new cljs.core.Keyword(null,"enlive","enlive",1679023921),null], null), null);
return (fexpr__54043.cljs$core$IFn$_invoke$arity$1 ? fexpr__54043.cljs$core$IFn$_invoke$arity$1(output_format) : fexpr__54043.call(null,output_format));
})())){
} else {
...
if(cljs.core.not(((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(start_rule),new cljs.core.Keyword(null,"cat","cat",-1457810207)))?(function (){var and__4174__auto__ = (function (){var G__54059 = new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(repeating_parser);
var fexpr__54058 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"star","star",279424429),null,new cljs.core.Keyword(null,"plus","plus",211540661),null], null), null);
return (fexpr__54058.cljs$core$IFn$_invoke$arity$1 ? fexpr__54058.cljs$core$IFn$_invoke$arity$1(G__54059) : fexpr__54058.call(null,G__54059));
})();
