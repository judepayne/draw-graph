...
lib_draw_graph.graph.str__GT_rgb.cljs$core$IFn$_invoke$arity$variadic = (function (s,p__35966){
...
var blend_with = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__35967__$1,new cljs.core.Keyword(null,"blend-with","blend-with",343035248),(12320699));
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("invis",p1__35980_SHARP_);
...
return cljs.core.not(lib_draw_graph.graph.edge_invisible_QMARK_(g,n,p1__35984_SHARP_));
});})(succs))
,succs);
...
return cljs.core.not(lib_draw_graph.graph.edge_invisible_QMARK_(g,n,p1__35998_SHARP_));
});})(succs))
,succs);
});
...
var G__36081 = (i__4731__auto___36078 + (1));
i__4731__auto___36078 = G__36081;
continue;
} else {
}
break;
...
/** @this {Function} */
lib_draw_graph.graph.group_map.cljs$lang$applyTo = (function (seq36005){
var G__36006 = cljs.core.first(seq36005);
var seq36005__$1 = cljs.core.next(seq36005);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36006,seq36005__$1);
});
...
var fexpr__36044 = cljs.core.partial.cljs$core$IFn$_invoke$arity$3(lib_draw_graph.clustered.node__GT_clusters,g,lib_draw_graph.clustered.cluster_key(g));
return (fexpr__36044.cljs$core$IFn$_invoke$arity$1 ? fexpr__36044.cljs$core$IFn$_invoke$arity$1(n) : fexpr__36044.call(null,n));
...
return loom.graph.successors_STAR_(g,p1__36051_SHARP_);
});})(ks))
;
