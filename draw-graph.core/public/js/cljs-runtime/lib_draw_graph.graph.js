...
var G__36024 = (i__4731__auto___36022 + (1));
i__4731__auto___36022 = G__36024;
continue;
} else {
}
break;
...
lib_draw_graph.graph.str__GT_rgb.cljs$core$IFn$_invoke$arity$variadic = (function (s,p__35964){
...
var blend_with = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__35965__$1,new cljs.core.Keyword(null,"blend-with","blend-with",343035248),(12320699));
...
/** @this {Function} */
lib_draw_graph.graph.str__GT_rgb.cljs$lang$applyTo = (function (seq35961){
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("invis",p1__35975_SHARP_);
...
return cljs.core.not(lib_draw_graph.graph.edge_invisible_QMARK_(g,n,p1__35979_SHARP_));
});})(succs))
,succs);
...
return cljs.core.not(lib_draw_graph.graph.edge_invisible_QMARK_(g,n,p1__35985_SHARP_));
});})(succs))
,succs);
});
...
/** @this {Function} */
lib_draw_graph.graph.group_map.cljs$lang$applyTo = (function (seq35994){
var G__35995 = cljs.core.first(seq35994);
var seq35994__$1 = cljs.core.next(seq35994);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35995,seq35994__$1);
});
...
return lib_draw_graph.graph.str__GT_rgb((function (){var fexpr__36005 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(color_key);
return (fexpr__36005.cljs$core$IFn$_invoke$arity$1 ? fexpr__36005.cljs$core$IFn$_invoke$arity$1(n) : fexpr__36005.call(null,n));
})());
});
/**
...
var v = (function (){var fexpr__36007 = cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(p1__36006_SHARP_);
return (fexpr__36007.cljs$core$IFn$_invoke$arity$1 ? fexpr__36007.cljs$core$IFn$_invoke$arity$1(metadata) : fexpr__36007.call(null,metadata));
})();
...
var fexpr__36016 = cljs.core.partial.cljs$core$IFn$_invoke$arity$3(lib_draw_graph.clustered.node__GT_clusters,g,lib_draw_graph.clustered.cluster_key(g));
return (fexpr__36016.cljs$core$IFn$_invoke$arity$1 ? fexpr__36016.cljs$core$IFn$_invoke$arity$1(n) : fexpr__36016.call(null,n));
...
return loom.graph.successors_STAR_(g,p1__36019_SHARP_);
});})(ks))
;
