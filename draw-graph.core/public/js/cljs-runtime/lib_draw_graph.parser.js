...
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"header","header",119441134),(function (){var G__36086 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"H","H",-938148327),(function (args){
...
lib_draw_graph.parser.attribute_map.cljs$core$IFn$_invoke$arity$variadic = (function (s,p__36092){
var map__36094 = p__36092;
...
var meta_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36094__$1,new cljs.core.Keyword(null,"meta?","meta?",1044243367),false);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (s_SINGLEQUOTE_,args,n,map__36094,map__36094__$1,meta_QMARK_){
return (function (acc,p__36108){
...
});})(s_SINGLEQUOTE_,args,n,map__36094,map__36094__$1,meta_QMARK_))
...
/** @this {Function} */
lib_draw_graph.parser.attribute_map.cljs$lang$applyTo = (function (seq36090){
var G__36091 = cljs.core.first(seq36090);
var seq36090__$1 = cljs.core.next(seq36090);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36091,seq36090__$1);
});
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4523__auto__ = (function lib_draw_graph$parser$map_vals_$_iter__36118(s__36119){
...
var vec__36132 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__36120);
...
cljs.core.chunk_append(b__36121,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(v) : f.call(null,v))], null));

var G__36343 = (i__36120 + (1));
i__36120 = G__36343;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__36121),lib_draw_graph$parser$map_vals_$_iter__36118(cljs.core.chunk_rest(s__36119__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__36121),null);
}
} else {
var vec__36136 = cljs.core.first(s__36119__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(v) : f.call(null,v))], null),lib_draw_graph$parser$map_vals_$_iter__36118(cljs.core.rest(s__36119__$2)));
}
} else {
return null;
}
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__36144){
var vec__36146 = p__36144;
...
var nd = (function (){var G__36167 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"Node-style","Node-style",2061401402),lib_draw_graph.parser.attribute_map,new cljs.core.Keyword(null,"Synonym","Synonym",-1939709262),(function (arg){
return arg;
...
var node = cljs.core.zipmap(new cljs.core.Keyword(null,"header","header",119441134).cljs$core$IFn$_invoke$arity$1(state),lib_draw_graph.parser.split_parts_meta((function (){var G__36173 = cljs.core.second(args);
...
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"nodes","nodes",-2099585805),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"node","node",581201198),cljs.core.zipmap(new cljs.core.Keyword(null,"header","header",119441134).cljs$core$IFn$_invoke$arity$1(state),lib_draw_graph.parser.split_parts_meta((function (){var G__36176 = cljs.core.first(args);
return (lib_draw_graph.parser.unesc.cljs$core$IFn$_invoke$arity$1 ? lib_draw_graph.parser.unesc.cljs$core$IFn$_invoke$arity$1(G__36176) : lib_draw_graph.parser.unesc.call(null,G__36176));
...
var node = cljs.core.zipmap(new cljs.core.Keyword(null,"header","header",119441134).cljs$core$IFn$_invoke$arity$1(state),lib_draw_graph.parser.split_parts_meta((function (){var G__36182 = cljs.core.second(args);
return (lib_draw_graph.parser.unesc.cljs$core$IFn$_invoke$arity$1 ? lib_draw_graph.parser.unesc.cljs$core$IFn$_invoke$arity$1(G__36182) : lib_draw_graph.parser.unesc.call(null,G__36182));
})()));
...
G__36356.cljs$lang$applyTo = (function (arglist__36362){
...
var edge = (function (){var G__36191 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"Node-style","Node-style",2061401402),lib_draw_graph.parser.attribute_map,new cljs.core.Keyword(null,"Node","Node",-1194498536),((function (nk,sk){
return (function() { 
...
return cljs.core.PersistentArrayMap.createAsIfByAssoc([nk,cljs.core.zipmap(new cljs.core.Keyword(null,"header","header",119441134).cljs$core$IFn$_invoke$arity$1(state),lib_draw_graph.parser.split_parts_meta((function (){var G__36217 = cljs.core.first(args);
return (lib_draw_graph.parser.unesc.cljs$core$IFn$_invoke$arity$1 ? lib_draw_graph.parser.unesc.cljs$core$IFn$_invoke$arity$1(G__36217) : lib_draw_graph.parser.unesc.call(null,G__36217));
...
while (G__36368__i < G__36368__a.length) {G__36368__a[G__36368__i] = arguments[G__36368__i + 0]; ++G__36368__i;}
  args = new cljs.core.IndexedSeq(G__36368__a,0,null);
} 
return G__36364__delegate.call(this,args);};
G__36364.cljs$lang$maxFixedArity = 0;
G__36364.cljs$lang$applyTo = (function (arglist__36369){
...
G__36370.cljs$lang$applyTo = (function (arglist__36374){
...
return (function() { 
var G__36376__delegate = function (args){
...
var G__36376 = function (var_args){
var args = null;
if (arguments.length > 0) {
...
return G__36376__delegate.call(this,args);};
G__36376.cljs$lang$maxFixedArity = 0;
G__36376.cljs$lang$applyTo = (function (arglist__36397){
var args = cljs.core.seq(arglist__36397);
return G__36376__delegate(args);
});
...
return (function() { 
var G__36400__delegate = function (args){
return args;
};
...
while (G__36401__i < G__36401__a.length) {G__36401__a[G__36401__i] = arguments[G__36401__i + 0]; ++G__36401__i;}
  args = new cljs.core.IndexedSeq(G__36401__a,0,null);
} 
return G__36400__delegate.call(this,args);};
G__36400.cljs$lang$maxFixedArity = 0;
G__36400.cljs$lang$applyTo = (function (arglist__36402){
var args = cljs.core.seq(arglist__36402);
return G__36400__delegate(args);
});
...
var G__36192 = s;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__36191,G__36192) : instaparse.core.transform.call(null,G__36191,G__36192));
})();
var edge_SINGLEQUOTE_ = edge;
var edge__$1 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"edges","edges",-694791395),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"src","src",-1651076051),(function (){var G__36228 = cljs.core.first(edge_SINGLEQUOTE_);
return (nk.cljs$core$IFn$_invoke$arity$1 ? nk.cljs$core$IFn$_invoke$arity$1(G__36228) : nk.call(null,G__36228));
})(),new cljs.core.Keyword(null,"dst","dst",844682948),(function (){var G__36229 = cljs.core.second(edge_SINGLEQUOTE_);
return (nk.cljs$core$IFn$_invoke$arity$1 ? nk.cljs$core$IFn$_invoke$arity$1(G__36229) : nk.call(null,G__36229));
...
var cluster = (function (){var G__36241 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"Cs","Cs",771253187),(function() { 
...
while (G__36427__i < G__36427__a.length) {G__36427__a[G__36427__i] = arguments[G__36427__i + 0]; ++G__36427__i;}
  args = new cljs.core.IndexedSeq(G__36427__a,0,null);
} 
return G__36424__delegate.call(this,args);};
G__36424.cljs$lang$maxFixedArity = 0;
G__36424.cljs$lang$applyTo = (function (arglist__36428){
...
var G__36242 = s;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__36241,G__36242) : instaparse.core.transform.call(null,G__36241,G__36242));
})();
...
var relns = (function (){var G__36245 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"Cp","Cp",842325125),lib_draw_graph.parser.pairs], null);
var G__36246 = s;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__36245,G__36246) : instaparse.core.transform.call(null,G__36245,G__36246));
})();
...
var relns = (function (){var G__36250 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"Ce","Ce",-1152278075),lib_draw_graph.parser.pairs], null);
var G__36251 = s;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__36250,G__36251) : instaparse.core.transform.call(null,G__36250,G__36251));
})();
...
var p = (function (){var G__36262 = clojure.string.trim(cur);
return (lib_draw_graph.parser.csv_line_parser.cljs$core$IFn$_invoke$arity$1 ? lib_draw_graph.parser.csv_line_parser.cljs$core$IFn$_invoke$arity$1(G__36262) : lib_draw_graph.parser.csv_line_parser.call(null,G__36262));
})();
...
var G__36263 = cljs.core.first(line);
...
var new_nodes = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__36266){
...
return (function (m,p__36305){
var vec__36307 = p__36305;
...
var parsed0 = (function (){var G__36316 = fmt;
