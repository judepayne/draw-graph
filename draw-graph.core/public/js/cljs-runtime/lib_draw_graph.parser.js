...
}catch (e35961){if((e35961 instanceof Error)){
var e = e35961;
return null;
} else {
throw e35961;
...
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"header","header",119441134),(function (){var G__35975 = new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"H","H",-938148327),(function (args){
...
var G__35976 = s;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__35975,G__35976) : instaparse.core.transform.call(null,G__35975,G__35976));
})()], null);
});
...
while(true){
if((i__4731__auto___36139 < len__4730__auto___36137)){
...
lib_draw_graph.parser.attribute_map.cljs$core$IFn$_invoke$arity$variadic = (function (s,p__35988){
...
var meta_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__35989__$1,new cljs.core.Keyword(null,"meta?","meta?",1044243367),false);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (s_SINGLEQUOTE_,args,n,map__35989,map__35989__$1,meta_QMARK_){
return (function (acc,p__35997){
var vec__35998 = p__35997;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35998,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__35998,(1),null);
...
});})(s_SINGLEQUOTE_,args,n,map__35989,map__35989__$1,meta_QMARK_))
...
/** @this {Function} */
lib_draw_graph.parser.attribute_map.cljs$lang$applyTo = (function (seq35981){
var G__35982 = cljs.core.first(seq35981);
var seq35981__$1 = cljs.core.next(seq35981);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__35982,seq35981__$1);
});
...
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,(function (){var iter__4523__auto__ = (function lib_draw_graph$parser$map_vals_$_iter__36019(s__36020){
return (new cljs.core.LazySeq(null,(function (){
var s__36020__$1 = s__36020;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__36020__$1);
if(temp__5720__auto__){
var s__36020__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__36020__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__36020__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__36022 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__36021 = (0);
while(true){
if((i__36021 < size__4522__auto__)){
var vec__36026 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__36021);
...
cljs.core.chunk_append(b__36022,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(v) : f.call(null,v))], null));

var G__36151 = (i__36021 + (1));
i__36021 = G__36151;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__36022),lib_draw_graph$parser$map_vals_$_iter__36019(cljs.core.chunk_rest(s__36020__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__36022),null);
}
} else {
var vec__36031 = cljs.core.first(s__36020__$2);
...
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [k,(f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(v) : f.call(null,v))], null),lib_draw_graph$parser$map_vals_$_iter__36019(cljs.core.rest(s__36020__$2)));
}
} else {
return null;
}
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__36035){
var vec__36036 = p__36035;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36036,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36036,(1),null);
...
var nd = (function (){var G__36041 = new cljs.core.PersistentArrayMap(null, 3, [new cljs.core.Keyword(null,"Node-style","Node-style",2061401402),lib_draw_graph.parser.attribute_map,new cljs.core.Keyword(null,"Synonym","Synonym",-1939709262),(function (arg){
return arg;
}),new cljs.core.Keyword(null,"N","N",-640629860),(function() { 
var G__36159__delegate = function (args){
...
var node = cljs.core.zipmap(new cljs.core.Keyword(null,"header","header",119441134).cljs$core$IFn$_invoke$arity$1(state),lib_draw_graph.parser.split_parts_meta((function (){var G__36043 = cljs.core.second(args);
return (lib_draw_graph.parser.unesc.cljs$core$IFn$_invoke$arity$1 ? lib_draw_graph.parser.unesc.cljs$core$IFn$_invoke$arity$1(G__36043) : lib_draw_graph.parser.unesc.call(null,G__36043));
})()));
...
return new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"nodes","nodes",-2099585805),new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null,"node","node",581201198),cljs.core.zipmap(new cljs.core.Keyword(null,"header","header",119441134).cljs$core$IFn$_invoke$arity$1(state),lib_draw_graph.parser.split_parts_meta((function (){var G__36044 = cljs.core.first(args);
return (lib_draw_graph.parser.unesc.cljs$core$IFn$_invoke$arity$1 ? lib_draw_graph.parser.unesc.cljs$core$IFn$_invoke$arity$1(G__36044) : lib_draw_graph.parser.unesc.call(null,G__36044));
...
var node = cljs.core.zipmap(new cljs.core.Keyword(null,"header","header",119441134).cljs$core$IFn$_invoke$arity$1(state),lib_draw_graph.parser.split_parts_meta((function (){var G__36045 = cljs.core.second(args);
return (lib_draw_graph.parser.unesc.cljs$core$IFn$_invoke$arity$1 ? lib_draw_graph.parser.unesc.cljs$core$IFn$_invoke$arity$1(G__36045) : lib_draw_graph.parser.unesc.call(null,G__36045));
})()));
...
var G__36159 = function (var_args){
var args = null;
...
return G__36159__delegate.call(this,args);};
G__36159.cljs$lang$maxFixedArity = 0;
G__36159.cljs$lang$applyTo = (function (arglist__36162){
var args = cljs.core.seq(arglist__36162);
return G__36159__delegate(args);
});
...
var G__36042 = s;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__36041,G__36042) : instaparse.core.transform.call(null,G__36041,G__36042));
})();
...
var edge = (function (){var G__36047 = new cljs.core.PersistentArrayMap(null, 5, [new cljs.core.Keyword(null,"Node-style","Node-style",2061401402),lib_draw_graph.parser.attribute_map,new cljs.core.Keyword(null,"Node","Node",-1194498536),((function (nk,sk){
return (function() { 
var G__36163__delegate = function (args){
...
return cljs.core.PersistentArrayMap.createAsIfByAssoc([nk,cljs.core.zipmap(new cljs.core.Keyword(null,"header","header",119441134).cljs$core$IFn$_invoke$arity$1(state),lib_draw_graph.parser.split_parts_meta((function (){var G__36049 = cljs.core.first(args);
return (lib_draw_graph.parser.unesc.cljs$core$IFn$_invoke$arity$1 ? lib_draw_graph.parser.unesc.cljs$core$IFn$_invoke$arity$1(G__36049) : lib_draw_graph.parser.unesc.call(null,G__36049));
...
while (G__36164__i < G__36164__a.length) {G__36164__a[G__36164__i] = arguments[G__36164__i + 0]; ++G__36164__i;}
  args = new cljs.core.IndexedSeq(G__36164__a,0,null);
} 
return G__36163__delegate.call(this,args);};
G__36163.cljs$lang$maxFixedArity = 0;
G__36163.cljs$lang$applyTo = (function (arglist__36165){
var args = cljs.core.seq(arglist__36165);
return G__36163__delegate(args);
});
...
return (function() { 
var G__36166__delegate = function (args){
...
while (G__36167__i < G__36167__a.length) {G__36167__a[G__36167__i] = arguments[G__36167__i + 0]; ++G__36167__i;}
  args = new cljs.core.IndexedSeq(G__36167__a,0,null);
} 
return G__36166__delegate.call(this,args);};
G__36166.cljs$lang$maxFixedArity = 0;
G__36166.cljs$lang$applyTo = (function (arglist__36168){
var args = cljs.core.seq(arglist__36168);
return G__36166__delegate(args);
});
...
return (function() { 
var G__36169__delegate = function (args){
...
return G__36169__delegate.call(this,args);};
G__36169.cljs$lang$maxFixedArity = 0;
G__36169.cljs$lang$applyTo = (function (arglist__36171){
var args = cljs.core.seq(arglist__36171);
return G__36169__delegate(args);
});
...
return (function() { 
var G__36172__delegate = function (args){
return args;
};
...
while (G__36173__i < G__36173__a.length) {G__36173__a[G__36173__i] = arguments[G__36173__i + 0]; ++G__36173__i;}
  args = new cljs.core.IndexedSeq(G__36173__a,0,null);
} 
return G__36172__delegate.call(this,args);};
...
return G__36172__delegate(args);
});
...
var G__36048 = s;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__36047,G__36048) : instaparse.core.transform.call(null,G__36047,G__36048));
})();
var edge_SINGLEQUOTE_ = edge;
var edge__$1 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"edges","edges",-694791395),new cljs.core.PersistentArrayMap(null, 4, [new cljs.core.Keyword(null,"src","src",-1651076051),(function (){var G__36051 = cljs.core.first(edge_SINGLEQUOTE_);
return (nk.cljs$core$IFn$_invoke$arity$1 ? nk.cljs$core$IFn$_invoke$arity$1(G__36051) : nk.call(null,G__36051));
})(),new cljs.core.Keyword(null,"dst","dst",844682948),(function (){var G__36052 = cljs.core.second(edge_SINGLEQUOTE_);
return (nk.cljs$core$IFn$_invoke$arity$1 ? nk.cljs$core$IFn$_invoke$arity$1(G__36052) : nk.call(null,G__36052));
...
var cluster = (function (){var G__36055 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"Cs","Cs",771253187),(function() { 
var G__36190__delegate = function (args){
...
while (G__36191__i < G__36191__a.length) {G__36191__a[G__36191__i] = arguments[G__36191__i + 0]; ++G__36191__i;}
  args = new cljs.core.IndexedSeq(G__36191__a,0,null);
} 
return G__36190__delegate.call(this,args);};
G__36190.cljs$lang$maxFixedArity = 0;
G__36190.cljs$lang$applyTo = (function (arglist__36192){
var args = cljs.core.seq(arglist__36192);
return G__36190__delegate(args);
});
...
var G__36056 = s;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__36055,G__36056) : instaparse.core.transform.call(null,G__36055,G__36056));
})();
...
var relns = (function (){var G__36057 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"Cp","Cp",842325125),lib_draw_graph.parser.pairs], null);
var G__36058 = s;
...
var relns = (function (){var G__36060 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"Ce","Ce",-1152278075),lib_draw_graph.parser.pairs], null);
var G__36061 = s;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__36060,G__36061) : instaparse.core.transform.call(null,G__36060,G__36061));
})();
...
var G__36066 = cljs.core.first(line);
var G__36066__$1 = (((G__36066 instanceof cljs.core.Keyword))?G__36066.fqn:null);
switch (G__36066__$1) {
case "H":
...
var new_nodes = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (m,p__36070){
...
var parsed0 = (function (){var G__36115 = fmt;
