...
return clojure.string.join.cljs$core$IFn$_invoke$arity$1((function (){var iter__4523__auto__ = (function markdown$lists$close_lists_$_iter__36126(s__36127){
return (new cljs.core.LazySeq(null,(function (){
var s__36127__$1 = s__36127;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__36127__$1);
if(temp__5720__auto__){
var s__36127__$2 = temp__5720__auto__;
if(cljs.core.chunked_seq_QMARK_(s__36127__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__36127__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__36129 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__36128 = (0);
while(true){
if((i__36128 < size__4522__auto__)){
var vec__36138 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__36128);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36138,(0),null);
cljs.core.chunk_append(b__36129,["</li></",cljs.core.name(list_type),">"].join(''));

var G__36291 = (i__36128 + (1));
i__36128 = G__36291;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__36129),markdown$lists$close_lists_$_iter__36126(cljs.core.chunk_rest(s__36127__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__36129),null);
}
} else {
var vec__36147 = cljs.core.first(s__36127__$2);
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36147,(0),null);
return cljs.core.cons(["</li></",cljs.core.name(list_type),">"].join(''),markdown$lists$close_lists_$_iter__36126(cljs.core.rest(s__36127__$2)));
}
} else {
return null;
}
...
var lists_to_close = cljs.core.take_while.cljs$core$IFn$_invoke$arity$2((function (p1__36174_SHARP_){
return (cljs.core.second(p1__36174_SHARP_) > num_indents);
...
var vec__36230 = cljs.core.last(new cljs.core.Keyword(null,"lists","lists",-884730684).cljs$core$IFn$_invoke$arity$1(state));
var list_type = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36230,(0),null);
var indents = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36230,(1),null);
...
var content = clojure.string.trim((function (){var G__36248 = text;
var G__36249 = (num_indents + (1));
return (markdown.common._STAR_substring_STAR_.cljs$core$IFn$_invoke$arity$2 ? markdown.common._STAR_substring_STAR_.cljs$core$IFn$_invoke$arity$2(G__36248,G__36249) : markdown.common._STAR_substring_STAR_.call(null,G__36248,G__36249));
})());
...
markdown.lists.li = (function markdown$lists$li(text,p__36268){
...
var state = map__36269__$1;
var codeblock = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36269__$1,new cljs.core.Keyword(null,"codeblock","codeblock",-851153855));
var last_line_empty_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36269__$1,new cljs.core.Keyword(null,"last-line-empty?","last-line-empty?",1279111527));
var eof = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36269__$1,new cljs.core.Keyword(null,"eof","eof",-489063237));
var lists = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__36269__$1,new cljs.core.Keyword(null,"lists","lists",-884730684));
