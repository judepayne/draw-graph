...
var G__28553 = o;
(G__28553[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
G__28811.cljs$lang$applyTo = (function (arglist__28815){
var args = cljs.core.seq(arglist__28815);
...
var G__28554 = o;
(G__28554[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
G__28819.cljs$lang$applyTo = (function (arglist__28822){
...
var G__28564 = props;
var G__28564__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28564,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__28564);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__28564__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__28569){
var map__28576 = p__28569;
...
var props = map__28576__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28576__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__28595){
var map__28596 = p__28595;
var map__28596__$1 = (((((!((map__28596 == null))))?(((((map__28596.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__28596.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__28596):map__28596);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__28596__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__28615 = jsprops;
(G__28615["defaultValue"] = value);

(G__28615["onChange"] = (function (p1__28610_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__28610_SHARP_);
}));
...
var vec__28628 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28628,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28628,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28628,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___28892 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___28892 == null)){
} else {
var key_28893 = temp__5739__auto___28892;
(jsprops["key"] = key_28893);
}
...
var temp__5739__auto___28894 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___28894 == null)){
} else {
var key_28895 = temp__5739__auto___28894;
reagent.impl.template.oset(jsprops,"key",key_28895);
}
...
var G__28657 = reagent.impl.template.__GT_NativeWrapper();
(G__28657["name"] = c);
...
var G__28668 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__28668) : reagent.impl.template.as_element.call(null,G__28668));
} else {
...
var len__4789__auto___28906 = arguments.length;
var i__4790__auto___28908 = (0);
while(true){
if((i__4790__auto___28908 < len__4789__auto___28906)){
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28700){
var G__28719 = cljs.core.first(seq28700);
var seq28700__$1 = cljs.core.next(seq28700);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__28719,seq28700__$1);
}));
...
break;
default:
var G__28915 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__28915;
continue;
...
var n__4666__auto___28920 = a.length;
var i_28921 = (0);
while(true){
if((i_28921 < n__4666__auto___28920)){
(a[i_28921] = reagent.impl.template.as_element((a[i_28921])));

var G__28922 = (i_28921 + (1));
i_28921 = G__28922;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4666__auto___28924 = a.length;
var i_28925 = (0);
while(true){
if((i_28925 < n__4666__auto___28924)){
var val_28926 = (a[i_28925]);
if(((cljs.core.vector_QMARK_(val_28926)) && ((reagent.impl.template.key_from_vec(val_28926) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_28925] = reagent.impl.template.as_element(val_28926));
...
var ctx = ({});
var vec__28761 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28761,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__28761,(1),null);
...
var G__28774 = (cljs.core.count(argv) - first_child);
switch (G__28774) {
case (0):
