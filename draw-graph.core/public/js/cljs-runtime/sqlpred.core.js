...
var G__36083__delegate = function (args){
...
while (G__36085__i < G__36085__a.length) {G__36085__a[G__36085__i] = arguments[G__36085__i + 0]; ++G__36085__i;}
  args = new cljs.core.IndexedSeq(G__36085__a,0,null);
} 
return G__36083__delegate.call(this,args);};
G__36083.cljs$lang$maxFixedArity = 0;
G__36083.cljs$lang$applyTo = (function (arglist__36086){
var args = cljs.core.seq(arglist__36086);
return G__36083__delegate(args);
});
...
var G__36088__delegate = function (args){
...
while (G__36090__i < G__36090__a.length) {G__36090__a[G__36090__i] = arguments[G__36090__i + 0]; ++G__36090__i;}
  args = new cljs.core.IndexedSeq(G__36090__a,0,null);
} 
return G__36088__delegate.call(this,args);};
G__36088.cljs$lang$maxFixedArity = 0;
G__36088.cljs$lang$applyTo = (function (arglist__36091){
var args = cljs.core.seq(arglist__36091);
return G__36088__delegate(args);
});
...
var G__35993 = parsed;
return (instaparse.core.transform.cljs$core$IFn$_invoke$arity$2 ? instaparse.core.transform.cljs$core$IFn$_invoke$arity$2(G__35992,G__35993) : instaparse.core.transform.call(null,G__35992,G__35993));
});
sqlpred.core.filter_group = (function sqlpred$core$filter_group(transformed){
var t1 = cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__36003_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.list("or"),p1__36003_SHARP_);
}),cljs.core.partition_by.cljs$core$IFn$_invoke$arity$2((function (p1__36002_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("or",p1__36002_SHARP_);
}),transformed));
...
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2("and",p1__36004_SHARP_);
});})(t1))
,s);
});})(t1))
,t1);
...
var G__36042 = cljs.core.PersistentArrayMap.createAsIfByAssoc([k,v__$1]);
var G__36043 = item;
return (sqlpred.core.not_submap_QMARK_.cljs$core$IFn$_invoke$arity$2 ? sqlpred.core.not_submap_QMARK_.cljs$core$IFn$_invoke$arity$2(G__36042,G__36043) : sqlpred.core.not_submap_QMARK_.call(null,G__36042,G__36043));
} else {
...
if(cljs.core.truth_(not_QMARK_)){
return cljs.core.every_QMARK_(cljs.core.true_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36046_SHARP_){
return sqlpred.core.equality_match_QMARK_(k,p1__36046_SHARP_,true,skip_QMARK_,item);
}),vs));
} else {
return (!((cljs.core.some(cljs.core.true_QMARK_,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__36047_SHARP_){
return sqlpred.core.equality_match_QMARK_(k,p1__36047_SHARP_,false,skip_QMARK_,item);
}),vs)) == null)));
}
}
});
...
return cljs.core.some((function (p1__36059_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(cljs.core.get.cljs$core$IFn$_invoke$arity$2(item,new cljs.core.Keyword(null,"term","term",-1817390416).cljs$core$IFn$_invoke$arity$1(clause)),p1__36059_SHARP_);
...
sqlpred.core.sql_pred.cljs$core$IFn$_invoke$arity$variadic = (function (statement,p__36072){
...
var keywordize_keys_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36073__$1,new cljs.core.Keyword(null,"keywordize-keys?","keywordize-keys?",-254545987),false);
var skip_missing_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36073__$1,new cljs.core.Keyword(null,"skip-missing?","skip-missing?",554944425),false);
...
/** @this {Function} */
sqlpred.core.sql_pred.cljs$lang$applyTo = (function (seq36067){
