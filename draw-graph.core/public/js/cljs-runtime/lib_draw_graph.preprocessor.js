...
lib_draw_graph.preprocessor.subgraph.cljs$core$IFn$_invoke$arity$variadic = (function (g,n,p__36111){
...
var part_node_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36112__$1,new cljs.core.Keyword(null,"part-node?","part-node?",242747632),false);
var node = (cljs.core.truth_(part_node_QMARK_)?lib_draw_graph.preprocessor.find_node(g,n):n);
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(loom.graph.digraph,loom.alg_generic.pre_edge_traverse(((function (node,map__36112,map__36112__$1,part_node_QMARK_){
return (function (p1__36104_SHARP_){
return loom.graph.successors_STAR_(g,p1__36104_SHARP_);
});})(node,map__36112,map__36112__$1,part_node_QMARK_))
,node));
});
...
/** @this {Function} */
lib_draw_graph.preprocessor.subgraph.cljs$lang$applyTo = (function (seq36105){
...
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__36106,G__36107,seq36105__$2);
});
...
return cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__36118_SHARP_){
return lib_draw_graph.graph.leaf_QMARK_(g,p1__36118_SHARP_);
}),loom.graph.nodes(g));
});
/**
...
return cljs.core.not(lib_draw_graph.graph.edge_invisible_QMARK_(g__$1,p1__36119_SHARP_,n));
});})(prnts))
,prnts);
});
return cljs.core.dedupe.cljs$core$IFn$_invoke$arity$1(cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__36120_SHARP_){
return visible_parents(g,p1__36120_SHARP_);
...
var G__36343 = grph_STAR_;
var G__36344 = next_gen;
var G__36345 = (lvls - (1));
grph = G__36343;
nds = G__36344;
lvls = G__36345;
...
var G__36346 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(vertices,v);
var G__36347 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(explored,neighbours);
var G__36348 = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.pop(frontier),cljs.core.remove.cljs$core$IFn$_invoke$arity$2(explored,neighbours));
var G__36349 = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (vertices,explored,frontier,state,v,neighbours){
...
var vec__36160 = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__36151);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36160,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36160,(1),null);
...
var vec__36167 = cljs.core.first(s__36150__$2);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36167,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36167,(1),null);
...
return lib_draw_graph.preprocessor.fmap((function (p1__36171_SHARP_){
if(cljs.core.map_QMARK_(p1__36171_SHARP_)){
return (lib_draw_graph.preprocessor.fmap_STAR_.cljs$core$IFn$_invoke$arity$2 ? lib_draw_graph.preprocessor.fmap_STAR_.cljs$core$IFn$_invoke$arity$2(f,p1__36171_SHARP_) : lib_draw_graph.preprocessor.fmap_STAR_.call(null,f,p1__36171_SHARP_));
} else {
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(p1__36171_SHARP_) : f.call(null,p1__36171_SHARP_));
}
}),m);
});
/**
...
var r = cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$1((function (p__36174){
...
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.first,p1__36173_SHARP_);
});})(r))
,r);
});
/**
...
var G__36377 = cljs.core.rest(s__36196__$1);
s__36196__$1 = G__36377;
continue;
}
} else {
return null;
...
var edges = cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p1__36220_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$variadic(lib_draw_graph.preprocessor.edges_between,g,ri,cljs.core.first(cluster_edge_nums),cljs.core.second(cluster_edge_nums),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([p1__36220_SHARP_], 0));
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Keyword(null,"constraint","constraint",1725147424),cljs.core.nth.cljs$core$IFn$_invoke$arity$2(p1__36222_SHARP_,(2)));
});})(edges))
,edges);
...
var vec__36238 = p__36235;
var c1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36238,(0),null);
var c2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36238,(1),null);
...
var r_SINGLEQUOTE_ = cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.vals(cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (acc,p__36241){
...
var G__36382 = cljs.core.rest(old_ranks);
var G__36383 = acc;
var G__36384 = clstrs;
old_ranks = G__36382;
acc = G__36383;
...
var G__36386 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(acc,matched);
var G__36387 = unmatched;
old_ranks = G__36385;
acc = G__36386;
clstrs = G__36387;
continue;
...
return cljs.core.mapcat.cljs$core$IFn$_invoke$arity$variadic((function (p__36255){
var vec__36256 = p__36255;
var srcs = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36256,(0),null);
var dests = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36256,(1),null);
var iter__4523__auto__ = ((function (vec__36256,srcs,dests){
return (function lib_draw_graph$preprocessor$rankseq__GT_edges_$_iter__36259(s__36260){
return (new cljs.core.LazySeq(null,((function (vec__36256,srcs,dests){
return (function (){
var s__36260__$1 = s__36260;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__36260__$1);
if(temp__5720__auto__){
var xs__6277__auto__ = temp__5720__auto__;
var x = cljs.core.first(xs__6277__auto__);
var iterys__4519__auto__ = ((function (s__36260__$1,x,xs__6277__auto__,temp__5720__auto__,vec__36256,srcs,dests){
return (function lib_draw_graph$preprocessor$rankseq__GT_edges_$_iter__36259_$_iter__36261(s__36262){
return (new cljs.core.LazySeq(null,((function (s__36260__$1,x,xs__6277__auto__,temp__5720__auto__,vec__36256,srcs,dests){
return (function (){
var s__36262__$1 = s__36262;
while(true){
var temp__5720__auto____$1 = cljs.core.seq(s__36262__$1);
if(temp__5720__auto____$1){
var s__36262__$2 = temp__5720__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__36262__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__36262__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__36264 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__36263 = (0);
while(true){
if((i__36263 < size__4522__auto__)){
var y = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__36263);
cljs.core.chunk_append(b__36264,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y], null));

var G__36389 = (i__36263 + (1));
i__36263 = G__36389;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__36264),lib_draw_graph$preprocessor$rankseq__GT_edges_$_iter__36259_$_iter__36261(cljs.core.chunk_rest(s__36262__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__36264),null);
}
} else {
var y = cljs.core.first(s__36262__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [x,y], null),lib_draw_graph$preprocessor$rankseq__GT_edges_$_iter__36259_$_iter__36261(cljs.core.rest(s__36262__$2)));
}
} else {
return null;
}
...
});})(s__36260__$1,x,xs__6277__auto__,temp__5720__auto__,vec__36256,srcs,dests))
,null,null));
});})(s__36260__$1,x,xs__6277__auto__,temp__5720__auto__,vec__36256,srcs,dests))
;
var fs__4520__auto__ = cljs.core.seq(iterys__4519__auto__(dests));
if(fs__4520__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4520__auto__,lib_draw_graph$preprocessor$rankseq__GT_edges_$_iter__36259(cljs.core.rest(s__36260__$1)));
} else {
var G__36391 = cljs.core.rest(s__36260__$1);
s__36260__$1 = G__36391;
continue;
}
} else {
return null;
...
while(true){
if((i__4731__auto___36398 < len__4730__auto___36396)){
args__4736__auto__.push((arguments[i__4731__auto___36398]));

var G__36400 = (i__4731__auto___36398 + (1));
i__4731__auto___36398 = G__36400;
continue;
} else {
}
break;
...
lib_draw_graph.preprocessor.filter_graph.cljs$core$IFn$_invoke$arity$variadic = (function (g,sql,p__36278){
...
var filter_edges_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__36279__$1,new cljs.core.Keyword(null,"filter-edges?","filter-edges?",1330813465),true);
...
var edges_to_check = cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (filter_fn,filtered_nodes,g_SINGLEQUOTE_,map__36279,map__36279__$1,filter_edges_QMARK_){
return (function (p__36287){
var vec__36288 = p__36287;
var src = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36288,(0),null);
var dst = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36288,(1),null);
...
});})(filter_fn,filtered_nodes,g_SINGLEQUOTE_,map__36279,map__36279__$1,filter_edges_QMARK_))
,loom.graph.edges(g_SINGLEQUOTE_));
var filtered_edges = cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (edges_to_check,filter_fn,filtered_nodes,g_SINGLEQUOTE_,map__36279,map__36279__$1,filter_edges_QMARK_){
...
var G__36295 = loom.attr.attr.cljs$core$IFn$_invoke$arity$4(g_SINGLEQUOTE_,src,dst,new cljs.core.Keyword(null,"meta","meta",1499536964));
return (filter_fn.cljs$core$IFn$_invoke$arity$1 ? filter_fn.cljs$core$IFn$_invoke$arity$1(G__36295) : filter_fn.call(null,G__36295));
});})(edges_to_check,filter_fn,filtered_nodes,g_SINGLEQUOTE_,map__36279,map__36279__$1,filter_edges_QMARK_))
,edges_to_check);
...
/** @this {Function} */
lib_draw_graph.preprocessor.filter_graph.cljs$lang$applyTo = (function (seq36274){
var G__36275 = cljs.core.first(seq36274);
var seq36274__$1 = cljs.core.next(seq36274);
var G__36276 = cljs.core.first(seq36274__$1);
var seq36274__$2 = cljs.core.next(seq36274__$1);
var self__4717__auto__ = this;
...
return (function lib_draw_graph$preprocessor$paths_$_iter__36303(s__36304){
return (new cljs.core.LazySeq(null,((function (start_nodes,end_nodes){
return (function (){
var s__36304__$1 = s__36304;
while(true){
var temp__5720__auto__ = cljs.core.seq(s__36304__$1);
if(temp__5720__auto__){
var xs__6277__auto__ = temp__5720__auto__;
var s = cljs.core.first(xs__6277__auto__);
var iterys__4519__auto__ = ((function (s__36304__$1,s,xs__6277__auto__,temp__5720__auto__,start_nodes,end_nodes){
return (function lib_draw_graph$preprocessor$paths_$_iter__36303_$_iter__36305(s__36306){
return (new cljs.core.LazySeq(null,((function (s__36304__$1,s,xs__6277__auto__,temp__5720__auto__,start_nodes,end_nodes){
return (function (){
var s__36306__$1 = s__36306;
while(true){
var temp__5720__auto____$1 = cljs.core.seq(s__36306__$1);
if(temp__5720__auto____$1){
var s__36306__$2 = temp__5720__auto____$1;
...
var e = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__36307);
cljs.core.chunk_append(b__36308,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [s,e], null));

var G__36431 = (i__36307 + (1));
i__36307 = G__36431;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__36308),lib_draw_graph$preprocessor$paths_$_iter__36303_$_iter__36305(cljs.core.chunk_rest(s__36306__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__36308),null);
}
} else {
var e = cljs.core.first(s__36306__$2);
return cljs.core.cons(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [s,e], null),lib_draw_graph$preprocessor$paths_$_iter__36303_$_iter__36305(cljs.core.rest(s__36306__$2)));
}
} else {
return null;
}
...
});})(s__36304__$1,s,xs__6277__auto__,temp__5720__auto__,start_nodes,end_nodes))
,null,null));
});})(s__36304__$1,s,xs__6277__auto__,temp__5720__auto__,start_nodes,end_nodes))
;
var fs__4520__auto__ = cljs.core.seq(iterys__4519__auto__(end_nodes));
if(fs__4520__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4520__auto__,lib_draw_graph$preprocessor$paths_$_iter__36303(cljs.core.rest(s__36304__$1)));
} else {
var G__36435 = cljs.core.rest(s__36304__$1);
s__36304__$1 = G__36435;
continue;
}
} else {
return null;
...
return cljs.core.apply.cljs$core$IFn$_invoke$arity$3(loom.alg_generic.bf_path,cljs.core.partial.cljs$core$IFn$_invoke$arity$2(lib_draw_graph.graph.successors,g),p1__36301_SHARP_);
...
var vec__36318 = p__36313;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36318,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36318,(1),null);
var vec__36321 = cljs.core.vals(v);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36321,(0),null);
var inner = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__36321,(1),null);
