...
var pred__40558 = cljs.core._EQ_;
var expr__40559 = (this$["nodeType"]);
if(cljs.core.truth_((pred__40558.cljs$core$IFn$_invoke$arity$2 ? pred__40558.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__40559) : pred__40558.call(null,hickory.core.Attribute,expr__40559)))){
...
if(cljs.core.truth_((pred__40558.cljs$core$IFn$_invoke$arity$2 ? pred__40558.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__40559) : pred__40558.call(null,hickory.core.Comment,expr__40559)))){
return ["<!--",cljs.core.str.cljs$core$IFn$_invoke$arity$1((this$["data"])),"-->"].join('');
} else {
if(cljs.core.truth_((pred__40558.cljs$core$IFn$_invoke$arity$2 ? pred__40558.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__40559) : pred__40558.call(null,hickory.core.Document,expr__40559)))){
return cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["childNodes"]));
} else {
if(cljs.core.truth_((pred__40558.cljs$core$IFn$_invoke$arity$2 ? pred__40558.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__40559) : pred__40558.call(null,hickory.core.DocumentType,expr__40559)))){
return hickory.core.format_doctype(this$);
} else {
if(cljs.core.truth_((pred__40558.cljs$core$IFn$_invoke$arity$2 ? pred__40558.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__40559) : pred__40558.call(null,hickory.core.Element,expr__40559)))){
var tag = hickory.utils.lower_case_keyword((this$["tagName"]));
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag,cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["attributes"])))], null),(cljs.core.truth_((hickory.utils.unescapable_content.cljs$core$IFn$_invoke$arity$1 ? hickory.utils.unescapable_content.cljs$core$IFn$_invoke$arity$1(tag) : hickory.utils.unescapable_content.call(null,tag)))?cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__40549_SHARP_){
return (p1__40549_SHARP_["wholeText"]);
}),(this$["childNodes"])):cljs.core.map.cljs$core$IFn$_invoke$arity$2(hickory.core.as_hiccup,(this$["childNodes"])))));
} else {
if(cljs.core.truth_((pred__40558.cljs$core$IFn$_invoke$arity$2 ? pred__40558.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__40559) : pred__40558.call(null,hickory.core.Text,expr__40559)))){
return hickory.utils.html_escape((this$["wholeText"]));
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__40559)].join('')));
}
}
}
}
...
var pred__40567 = cljs.core._EQ_;
var expr__40568 = (this$["nodeType"]);
if(cljs.core.truth_((pred__40567.cljs$core$IFn$_invoke$arity$2 ? pred__40567.cljs$core$IFn$_invoke$arity$2(hickory.core.Attribute,expr__40568) : pred__40567.call(null,hickory.core.Attribute,expr__40568)))){
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [hickory.utils.lower_case_keyword((this$["name"])),(this$["value"])], null);
} else {
if(cljs.core.truth_((pred__40567.cljs$core$IFn$_invoke$arity$2 ? pred__40567.cljs$core$IFn$_invoke$arity$2(hickory.core.Comment,expr__40568) : pred__40567.call(null,hickory.core.Comment,expr__40568)))){
...
if(cljs.core.truth_((pred__40567.cljs$core$IFn$_invoke$arity$2 ? pred__40567.cljs$core$IFn$_invoke$arity$2(hickory.core.Document,expr__40568) : pred__40567.call(null,hickory.core.Document,expr__40568)))){
...
if(cljs.core.truth_((pred__40567.cljs$core$IFn$_invoke$arity$2 ? pred__40567.cljs$core$IFn$_invoke$arity$2(hickory.core.DocumentType,expr__40568) : pred__40567.call(null,hickory.core.DocumentType,expr__40568)))){
...
if(cljs.core.truth_((pred__40567.cljs$core$IFn$_invoke$arity$2 ? pred__40567.cljs$core$IFn$_invoke$arity$2(hickory.core.Element,expr__40568) : pred__40567.call(null,hickory.core.Element,expr__40568)))){
...
if(cljs.core.truth_((pred__40567.cljs$core$IFn$_invoke$arity$2 ? pred__40567.cljs$core$IFn$_invoke$arity$2(hickory.core.Text,expr__40568) : pred__40567.call(null,hickory.core.Text,expr__40568)))){
return (this$["wholeText"]);
} else {
throw (new Error(["No matching clause: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(expr__40568)].join('')));
}
}
}
}
...
var temp__5735__auto___40585 = cljs.core.first((doc["head"]["childNodes"]));
if(cljs.core.truth_(temp__5735__auto___40585)){
var title_el_40586 = temp__5735__auto___40585;
if(cljs.core.empty_QMARK_((title_el_40586["text"]))){
hickory.core.remove_el(title_el_40586);
} else {
}
} else {
}
