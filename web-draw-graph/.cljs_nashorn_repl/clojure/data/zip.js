...
return cljs.core.map.call(null,(function (p1__30007_SHARP_){
return clojure.data.zip.auto.call(null,false,p1__30007_SHARP_);
...
if(cljs.core.truth_(clojure.zip.branch_QMARK_.call(null,loc))){
return cljs.core.map.call(null,(function (p1__30008_SHARP_){
return clojure.data.zip.auto.call(null,true,p1__30008_SHARP_);
}),clojure.data.zip.right_locs.call(null,clojure.zip.down.call(null,loc)));
} else {
return null;
}
...
if(cljs.core.truth_((function (){var and__4036__auto__ = cljs.core.map_QMARK_.call(null,cljs.core.meta.call(null,rtn));
...
return cljs.core.mapcat.call(null,(function (p1__30009_SHARP_){
return clojure.data.zip.fixup_apply.call(null,(function (){var or__4047__auto__ = mkpred.call(null,expr);
